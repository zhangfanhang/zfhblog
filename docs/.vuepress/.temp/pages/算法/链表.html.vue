...
<p>链表头就是一个<code v-pre>链表</code>，因为链表是一个串，你拿起来头，自然拿起来一串</p>
</div>
<p>多个元素组成的列表。</p>
<p>元素存储不连续，用 next 指针连在一起。</p>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/链表1.png" alt="链表1" loading="lazy"></p>
<p>在数组中增删非首尾元素时往往需要移动元素，链表在增删非首尾元素，不需要移动元素，只需要更改 next 的指向即可。</p>
<p>js 中没有链表，需要用 Object 模拟:</p>
...
<p><a href="https://leetcode-cn.com/problems/delete-node-in-a-linked-list/" target="_blank" rel="noopener noreferrer">LeetCode：237.删除链表中的节点<ExternalLinkIcon/></a></p>
<ul>
<li>解题思路</li>
</ul>
<p>无法直接获取被删除节点的上个节点</p>
<p>把要删除的下个结点的值赋给被删除节点，然后将被删除节点的下一节点删除</p>
<p>比如 1-2-3-4 要删除 3，先 1-2-4-4 然后删除最后一个 4，最后变成 1-2-4</p>
<ul>
<li>解题步骤</li>
</ul>
<p>将被删节点的值改为下个节点的值。</p>
...
<p><a href="https://leetcode-cn.com/problems/reverse-linked-list/" target="_blank" rel="noopener noreferrer">LeetCode：206.反转链表<ExternalLinkIcon/></a></p>
<ul>
<li>解题思路</li>
</ul>
<p>反转两个节点：将 n+1 的 next 指向 n</p>
<p>反转多个节点：双指针遍历链表，重复上述操作。</p>
<ul>
<li>解题步骤</li>
</ul>
<p>双指针一前一后遍历链表。</p>
<p>反转双指针。</p>
<details class="custom-container details"><summary>解法一</summary>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">/*
...
<details class="custom-container details"><summary>解法二</summary>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">/*
 * @lc app=leetcode.cn id=206 lang=javascript
 *
 * [206] 反转链表
...
<h2 id="leetcode-2-两数相加" tabindex="-1"><a class="header-anchor" href="#leetcode-2-两数相加" aria-hidden="true">#</a> LeetCode：2. 两数相加</h2>
<p><a href="https://leetcode-cn.com/problems/add-two-numbers/" target="_blank" rel="noopener noreferrer">LeetCode：2. 两数相加<ExternalLinkIcon/></a></p>
<ul>
<li>解题思路</li>
</ul>
<p>小学数学题，模拟相加操作</p>
...
<span class="token punctuation">}</span>
<span class="token comment">// @lc code=end</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="leetcode-83-删除排序链表中的重复元素" tabindex="-1"><a class="header-anchor" href="#leetcode-83-删除排序链表中的重复元素" aria-hidden="true">#</a> LeetCode：83. 删除排序链表中的重复元素</h2>
<p><a href="https://leetcode-cn.com/problems/remove-duplicates-from-sorted-list/" target="_blank" rel="noopener noreferrer">LeetCode：83. 删除排序链表中的重复元素<ExternalLinkIcon/></a></p>
<ul>
<li>
<p>解题思路</p>
...
<span class="token punctuation">}</span>
<span class="token comment">// @lc code=end</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="leetcode-141-环形链表" tabindex="-1"><a class="header-anchor" href="#leetcode-141-环形链表" aria-hidden="true">#</a> LeetCode：141. 环形链表</h2>
<p><a href="https://leetcode-cn.com/problems/linked-list-cycle/" target="_blank" rel="noopener noreferrer">LeetCode：141. 环形链表<ExternalLinkIcon/></a></p>
<ul>
<li>解题思路</li>
</ul>
<p>两个人在圆形操场上的起点同时起跑，速度快的人一定会超过速度慢的人一圈</p>
<p>用一快一慢两个指针遍历链表，如果指针能够相逢，那么链表就有圈。</p>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/环形链表.png" alt="环形链表" loading="lazy"></p>
<ul>
<li>解题步骤</li>
</ul>
<p>用一快一慢两个指针遍历链表，如果指针能够相逢，就返回 true。</p>
<p>遍历结束后，还没有相逢就返回 false。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">/*
...
<span class="token punctuation">}</span>
<span class="token comment">// @lc code=end</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="leetcode-234-回文链表" tabindex="-1"><a class="header-anchor" href="#leetcode-234-回文链表" aria-hidden="true">#</a> LeetCode： 234. 回文链表</h2>
<p><a href="https://leetcode-cn.com/problems/palindrome-linked-list/" target="_blank" rel="noopener noreferrer">LeetCode： 234. 回文链表<ExternalLinkIcon/></a></p>
<ul>
<li>解题思路</li>
</ul>
<p>回文就是反转以后和以前一样的就是回文结构，例如 1-&gt;2-&gt;3-&gt;2-&gt;1，我们将它反转之后还是与原链表一样，我们就称这种链表结构为回文结构</p>
<ul>
<li>解题步骤</li>
</ul>
<p><strong>快慢指针</strong>，起初都指向表头，快指针一次走两步，慢指针一次走一步，遍历结束时：</p>
<p>要么，slow 正好指向中间两个结点的后一个。</p>
<p>要么，slow 正好指向中间结点。</p>
<p>用 prev 保存 slow 的前一个结点，通过<code v-pre>prev.next = null</code>断成两个链表。</p>
<p>将后半段链表翻转(<strong>参考 leetcode.206</strong>)，和前半段从头比对。</p>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/回文链表.png" alt="回文链表" loading="lazy"></p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">/*
...
<span class="token punctuation">}</span>
<span class="token comment">// @lc code=end</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="前端与链表-js-中的原型链" tabindex="-1"><a class="header-anchor" href="#前端与链表-js-中的原型链" aria-hidden="true">#</a> 前端与链表：JS 中的原型链</h2>
<p><strong>原型链的本质是<code v-pre>链表</code></strong>。</p>
<p>原型链上的节点是各种原型对象， 比如 <code v-pre>Function.prototype</code>、 <code v-pre>Object.prototype</code>……</p>
<p>原型链通过<code v-pre>__proto__</code>属性连接各种原型对象。</p>
<h3 id="面试题-instanceof-的原理-并用代码实现。" tabindex="-1"><a class="header-anchor" href="#面试题-instanceof-的原理-并用代码实现。" aria-hidden="true">#</a> 面试题：instanceof 的原理，并用代码实现。</h3>
<p>知识点：如果 A 沿着原型链能找到<code v-pre>B.prototype</code>，那么<code v-pre>A instanceof B</code>为 true。</p>
<p>解法：遍历 A 的原型链，如果找到<code v-pre>B.prototype</code>，返回 true，否则返回 false</p>
<h3 id="面试题-看输出" tabindex="-1"><a class="header-anchor" href="#面试题-看输出" aria-hidden="true">#</a> 面试题：看输出</h3>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> foo <span class="token operator">=</span> <span class="token punctuation">{</span><span class="token punctuation">}</span>
...
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token constant">F</span><span class="token punctuation">.</span>b<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>知识点：如果在 A 对象上没有找到 ⅹ 属性，那么会沿着原型链找 ⅹ 属性。</p>
<p>解法：明确 foo 和 F 变量的原型链，沿着原型链找 a 属性和 b 属性。</p>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/链表面试题2.png" alt="链表面试题2" loading="lazy"></p>
<h2 id="前端与链表-使用链表指针获取-json-的节点值" tabindex="-1"><a class="header-anchor" href="#前端与链表-使用链表指针获取-json-的节点值" aria-hidden="true">#</a> 前端与链表：使用链表指针获取 JSON 的节点值</h2>
