...
<p>一种<code v-pre>分层</code>数据的抽象模型</p>
<p><strong>js 中没有树</strong>，但是可以用<code v-pre>Object</code>和<code v-pre>Array</code>构建树</p>
<p>树的常用操作：深度/广度优先遍历,先中后序遍历</p>
<h2 id="深度与广度优先遍历" tabindex="-1"><a class="header-anchor" href="#深度与广度优先遍历" aria-hidden="true">#</a> 深度与广度优先遍历</h2>
<h3 id="深度优先遍历" tabindex="-1"><a class="header-anchor" href="#深度优先遍历" aria-hidden="true">#</a> 深度优先遍历</h3>
<p><strong>尽可能深的搜索树的分支</strong></p>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/深度优先遍历.png" alt="深度优先遍历" loading="lazy"></p>
<p>深度优先遍历算法口诀：</p>
<p>访问根节点</p>
<p>对根节点的<code v-pre>children</code><strong>挨个进行深度优先遍历</strong>。</p>
<details class="custom-container details"><summary>深度优先遍历 dfs</summary>
...
<p><strong>先访问离根节点最近的节点</strong></p>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/广度优先遍历.png" alt="广度优先遍历" loading="lazy"></p>
<p>广度优先遍历算法口诀：</p>
<ol>
<li>新建一个队列，把根节点入队。</li>
<li>把队头出队并访问。</li>
<li>把队头的<code v-pre>children</code>挨个入队。</li>
<li>重复第二、三步，直到队列为空。</li>
</ol>
<details class="custom-container details"><summary>广度优先遍历 bfs</summary>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token doc-comment comment">/**
 * 广度优先遍历 bfs
 */</span>
<span class="token keyword">const</span> tree <span class="token operator">=</span> <span class="token punctuation">{</span>
...
<span class="token keyword">const</span> <span class="token function-variable function">bfs</span> <span class="token operator">=</span> <span class="token parameter">root</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">while</span> <span class="token punctuation">(</span>q<span class="token punctuation">.</span>length <span class="token operator">></span> <span class="token number">0</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    ...
    n<span class="token punctuation">.</span>children<span class="token punctuation">.</span><span class="token function">forEach</span><span class="token punctuation">(</span><span class="token parameter">child</span> <span class="token operator">=></span> q<span class="token punctuation">.</span><span class="token function">push</span><span class="token punctuation">(</span>child<span class="token punctuation">)</span><span class="token punctuation">)</span>
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
...
<h2 id="二叉树的先中后序遍历" tabindex="-1"><a class="header-anchor" href="#二叉树的先中后序遍历" aria-hidden="true">#</a> 二叉树的先中后序遍历</h2>
<p>二叉树:<strong>树中每个节点最多只能有两个子节点</strong></p>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/二叉树.png" alt="二叉树" loading="lazy"></p>
<h3 id="一个普普通通的二叉树" tabindex="-1"><a class="header-anchor" href="#一个普普通通的二叉树" aria-hidden="true">#</a> 一个普普通通的二叉树</h3>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> bt <span class="token operator">=</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="先序遍历算法口诀" tabindex="-1"><a class="header-anchor" href="#先序遍历算法口诀" aria-hidden="true">#</a> 先序遍历算法口诀</h3>
<ol>
<li>访问<strong>根</strong>节点</li>
<li>对根节点的<strong>左</strong>子树进行先序遍历</li>
<li>对根节点的<strong>右</strong>子树进行先序遍历</li>
</ol>
<details class="custom-container details"><summary>preorder</summary>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token doc-comment comment">/**
 * preorder 先序遍历
 */</span>
...
<h3 id="中序遍历算法口诀" tabindex="-1"><a class="header-anchor" href="#中序遍历算法口诀" aria-hidden="true">#</a> 中序遍历算法口诀</h3>
<p>对根节点的<strong>左</strong>子树进行中序遍历</p>
<p>访问<strong>根</strong>节点</p>
<p>对根节点的<strong>右</strong>子树进行中序遍历</p>
<details class="custom-container details"><summary>inorder</summary>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token doc-comment comment">/**
 * inorder 中序遍历
 */</span>
...
<h3 id="后序遍历算法口诀" tabindex="-1"><a class="header-anchor" href="#后序遍历算法口诀" aria-hidden="true">#</a> 后序遍历算法口诀</h3>
<p>对根节点的<strong>左</strong>子树进行后序遍历</p>
<p>对根节点的<strong>右</strong>子树进行后序遍历</p>
<p>访问<strong>根</strong>节点</p>
<details class="custom-container details"><summary>postorder</summary>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token doc-comment comment">/**
 * postorder 后序遍历
 */</span>
<span class="token keyword">const</span> bt <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'./bt'</span><span class="token punctuation">)</span>
...
<h3 id="先中后序遍历非递归版" tabindex="-1"><a class="header-anchor" href="#先中后序遍历非递归版" aria-hidden="true">#</a> 先中后序遍历非递归版</h3>
<div class="custom-container tip">
<p class="custom-container-title">提示</p>
<p>画个栈理解</p>
</div>
<details class="custom-container details"><summary>先序遍历</summary>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token function-variable function">preorder</span> <span class="token operator">=</span> <span class="token parameter">root</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
...
<details class="custom-container details"><summary>中序遍历</summary>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token function-variable function">inorder</span> <span class="token operator">=</span> <span class="token parameter">root</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
  <span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token operator">!</span>root<span class="token punctuation">)</span> <span class="token keyword">return</span>
...
<div class="custom-container tip">
<p class="custom-container-title">提示</p>
<p>先序遍历：<strong>根—&gt;左—&gt;右</strong>,后序倒过来：<strong>左—&gt;右—&gt;根</strong></p>
<p>先先序遍历，然后利用另外一个栈，倒序输出</p>
</div>
<details class="custom-container details"><summary>后序遍历</summary>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token function-variable function">postorder</span> <span class="token operator">=</span> <span class="token parameter">root</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
  <span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token operator">!</span>root<span class="token punctuation">)</span> <span class="token keyword">return</span>
...
<h2 id="leetcode-144-二叉树的前序遍历" tabindex="-1"><a class="header-anchor" href="#leetcode-144-二叉树的前序遍历" aria-hidden="true">#</a> LeetCode：144. 二叉树的前序遍历</h2>
<p><a href="https://leetcode-cn.com/problems/maximum-depth-of-binary-tree/" target="_blank" rel="noopener noreferrer">LeetCode：144. 二叉树的前序遍历<ExternalLinkIcon/></a></p>
...
<h2 id="leetcode-145-二叉树的后序遍历" tabindex="-1"><a class="header-anchor" href="#leetcode-145-二叉树的后序遍历" aria-hidden="true">#</a> LeetCode：145. 二叉树的后序遍历</h2>
<p><a href="https://leetcode-cn.com/problems/binary-tree-postorder-traversal/" target="_blank" rel="noopener noreferrer">LeetCode：145. 二叉树的后序遍历<ExternalLinkIcon/></a></p>
<details class="custom-container details"><summary>code</summary>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">/*
...
<h2 id="leetcode-104-二叉树的最大深度" tabindex="-1"><a class="header-anchor" href="#leetcode-104-二叉树的最大深度" aria-hidden="true">#</a> LeetCode：104. 二叉树的最大深度</h2>
<p><a href="https://leetcode-cn.com/problems/maximum-depth-of-binary-tree/" target="_blank" rel="noopener noreferrer">LeetCode：104. 二叉树的最大深度<ExternalLinkIcon/></a></p>
<ul>
<li>解题思路</li>
</ul>
<p>求最大深度，考虑使用深度优先遍历。</p>
<p>在深度优先遍历过程中，记录每个节点所在的层级，找出最大的层级即可。</p>
<ul>
<li>解题步骤</li>
</ul>
<p>新建一个变量，记录最大深度。</p>
<p>深度优先遍历整棵树，并记录每个节点的层级，同时不断刷新最大深度这个变量。</p>
<p>遍历结束返回最大深度这个变量</p>
<details class="custom-container details"><summary>code</summary>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">/*
...
<h2 id="leetcode-111-二叉树的最小深度" tabindex="-1"><a class="header-anchor" href="#leetcode-111-二叉树的最小深度" aria-hidden="true">#</a> LeetCode：111. 二叉树的最小深度</h2>
<p><a href="https://leetcode-cn.com/problems/minimum-depth-of-binary-tree/" target="_blank" rel="noopener noreferrer">LeetCode：111. 二叉树的最小深度<ExternalLinkIcon/></a></p>
<ul>
<li>解题思路</li>
</ul>
<p>求最小深度，考虑使用广度优先遍历。</p>
<p>在广度优先遍历过程中，遇到叶子节点，停止遍历，返回节点层级。</p>
<ul>
<li>解题步骤</li>
</ul>
<p>广度优先遍历整棵树，并记录每个节点的层级</p>
<p>遇到叶子节点，返回节点层级，停止遍历</p>
<details class="custom-container details"><summary>code</summary>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">/*
...
<h2 id="leetcode-102-二叉树的层序遍历" tabindex="-1"><a class="header-anchor" href="#leetcode-102-二叉树的层序遍历" aria-hidden="true">#</a> LeetCode：102. 二叉树的层序遍历</h2>
<p><a href="https://leetcode-cn.com/problems/binary-tree-level-order-traversal/" target="_blank" rel="noopener noreferrer">LeetCode：102. 二叉树的层序遍历<ExternalLinkIcon/></a></p>
<ul>
<li>解题思路</li>
</ul>
<p>层序遍历顺序就是广度优先遍历。</p>
<p>不过在遍历时候需要<strong>记录当前节点所处的层级</strong>，方便将其添加到不同的数组中</p>
<ul>
<li>解题步骤</li>
</ul>
<p>广度优先遍历二叉树。</p>
<p>遍历过程中，记录每个节点的层级，并将其添加到不同的数组中。</p>
<details class="custom-container details"><summary>解法 1</summary>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">/*
...
<details class="custom-container details"><summary>解法 2</summary>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">/*
 * @lc app=leetcode.cn id=102 lang=javascript
 *
 * [102] 二叉树的层序遍历
...
<h2 id="leetcode-94-二叉树的中序遍历" tabindex="-1"><a class="header-anchor" href="#leetcode-94-二叉树的中序遍历" aria-hidden="true">#</a> LeetCode：94. 二叉树的中序遍历</h2>
<p><a href="https://leetcode-cn.com/problems/binary-tree-inorder-traversal/" target="_blank" rel="noopener noreferrer">LeetCode：94. 二叉树的中序遍历<ExternalLinkIcon/></a></p>
<details class="custom-container details"><summary>递归</summary>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">/*
...
<details class="custom-container details"><summary>迭代</summary>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">/*
 * @lc app=leetcode.cn id=94 lang=javascript
 *
 * [94] 二叉树的中序遍历
...
<h2 id="leetcode-112-路径总和" tabindex="-1"><a class="header-anchor" href="#leetcode-112-路径总和" aria-hidden="true">#</a> LeetCode：112. 路径总和</h2>
<p><a href="https://leetcode-cn.com/problems/path-sum/" target="_blank" rel="noopener noreferrer">LeetCode：112. 路径总和<ExternalLinkIcon/></a></p>
<ul>
<li>
<p>解题思路</p>
<p>在深度优先遍历的过程中，记录当前路径的节点值的和。</p>
<p>在叶子节点处，判断当前路径的节点值的和是否等于目标值。</p>
</li>
<li>
<p>解题步骤</p>
<p>深度优先遍历二叉树，在叶子节点处，判断当前路径的节点值的和是否等于目标值是就返回 true</p>
<p>遍历结束，如果没有匹配，就返回 false</p>
</li>
</ul>
<details class="custom-container details"><summary>code</summary>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">/*
...
<h2 id="前端与树-遍历-json-的所有节点值" tabindex="-1"><a class="header-anchor" href="#前端与树-遍历-json-的所有节点值" aria-hidden="true">#</a> 前端与树：遍历 JSON 的所有节点值</h2>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> json <span class="token operator">=</span> <span class="token punctuation">{</span>
