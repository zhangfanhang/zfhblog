...
<p>与集合类似，字典也是一种<strong>存储唯一值</strong>的数据结构，但它是以<strong>键值对</strong>的形式来存储。</p>
<p>ES6中有字典，名为<code v-pre>Map</code></p>
<p>字典的常用操作：键值对的增删改查</p>
<h2 id="leetcode-349-两个数组的交集" tabindex="-1"><a class="header-anchor" href="#leetcode-349-两个数组的交集" aria-hidden="true">#</a> LeetCode：349. 两个数组的交集</h2>
<p><a href="https://leetcode-cn.com/problems/intersection-of-two-arrays/" target="_blank" rel="noopener noreferrer">LeetCode：349. 两个数组的交集<ExternalLinkIcon/></a></p>
<ul>
<li>解题思路</li>
</ul>
<p>求nums1 和 nums2 都有的值</p>
<p>用字典建立一个映射关系，记录nums1里都有的值</p>
<p>遍历 nums2 找出nums1里也有的值</p>
<ul>
<li>解题步骤</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="leetcode-20-有效的括号" tabindex="-1"><a class="header-anchor" href="#leetcode-20-有效的括号" aria-hidden="true">#</a> LeetCode：20.有效的括号</h2>
<p><a href="https://leetcode-cn.com/problems/valid-parentheses/" target="_blank" rel="noopener noreferrer">LeetCode：20.有效的括号<ExternalLinkIcon/></a>
<strong>使用字典建立左右括号映射关系</strong></p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">/*
...
<span class="token punctuation">}</span>
<span class="token comment">// @lc code=end</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="leetcode-1-两数之和" tabindex="-1"><a class="header-anchor" href="#leetcode-1-两数之和" aria-hidden="true">#</a> LeetCode：1. 两数之和</h2>
<p><a href="https://leetcode-cn.com/problems/two-sum/" target="_blank" rel="noopener noreferrer">LeetCode：1. 两数之和<ExternalLinkIcon/></a></p>
<ul>
<li>解题思路</li>
</ul>
<p>把nums想象成相亲者</p>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
<span class="token comment">// @lc code=end</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="leetcode-3-无重复字符的最长子串" tabindex="-1"><a class="header-anchor" href="#leetcode-3-无重复字符的最长子串" aria-hidden="true">#</a> LeetCode：3. 无重复字符的最长子串</h2>
<p><a href="https://leetcode-cn.com/problems/longest-substring-without-repeating-characters/" target="_blank" rel="noopener noreferrer">LeetCode：3. 无重复字符的最长子串<ExternalLinkIcon/></a></p>
<ul>
<li>解题思路</li>
</ul>
<p>先找出所有的不包含重复字符的子串</p>
<p>找出长度最大那个子串，返回其长度即可。</p>
<ul>
<li>解题步骤</li>
</ul>
<p>用双指针维护一个<code v-pre>滑动窗口</code>(slice)，用来剪切子串。</p>
<p>不断移动右指针，遇到重复字符，就把左指针移动到重复字符的下一位。</p>
<p>过程中，记录所有窗口的长度，并返回最大值。</p>
<div class="custom-container warning">
<p class="custom-container-title">有个坑</p>
<p>如果输入的为“abbcdea”,无重复字符的最长子串的长度应该为5(&quot;bcdea&quot;)，此时左指针在索引为2的那一项，当右指针要马上指向最后一个a时，发现map中已经有一个a了，所以会移动左指针到索引为1的位置，这就导致输出结果为6了</p>
<p>解决方法：移动左指针时，必须确保<strong>重复字符的索引必须大于左指针的索引</strong></p>
</div>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">/*
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
<span class="token comment">// @lc code=end</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="leetcode-76-最小覆盖子串" tabindex="-1"><a class="header-anchor" href="#leetcode-76-最小覆盖子串" aria-hidden="true">#</a> LeetCode：76. 最小覆盖子串</h2>
<p><a href="https://leetcode-cn.com/problems/minimum-window-substring/" target="_blank" rel="noopener noreferrer">LeetCode：76. 最小覆盖子串<ExternalLinkIcon/></a></p>
<ul>
<li>解题思路</li>
</ul>
<p>先找出所有的包含T的子串。</p>
...
<p>用双指针维护一个滑动窗口。</p>
<p>移动右指针，找到包含T的子串，移动左指针，尽量减少包含T的子串的长度。</p>
<p>循环上述过程，找出包含T的最小子串</p>
<div class="custom-container tip">
<p class="custom-container-title">提示</p>
<p>substring参数为左闭右开区间，substring(a,b)可以得到从a开始到b结束（不包括b处）的子串</p>
</div>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">/*
