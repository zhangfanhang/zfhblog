<template><div><p>在 React 开发中，Hook，HOC 和 renderProps 它们均可以完成组件状态逻辑的复用</p>
<p>从难易程度上来说 Hook 相对于其余两种方式写起来要容易的多</p>
<p>现在我以 React 官方文档 中的<a href="https://zh-hans.reactjs.org/docs/render-props.html" target="_blank" rel="noopener noreferrer">renderProps<ExternalLinkIcon/></a> 一节里的鼠标移动案例，以三种方式编写，通过对比三种方式的难易程度显而易见</p>
<h2 id="renderprops" tabindex="-1"><a class="header-anchor" href="#renderprops" aria-hidden="true">#</a> renderProps</h2>
<p>renderProps 本质上是一个用于告知组件需要渲染什么内容的函数 prop</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>通过一个函数类型的 Prop，我们复用了 Mouse 组件的状态和逻辑。当然你也可以通过 children 传递它：</p>
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span><span class="token class-name">Mouse</span></span><span class="token punctuation">></span></span><span class="token plain-text">
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="hoc-高阶组件" tabindex="-1"><a class="header-anchor" href="#hoc-高阶组件" aria-hidden="true">#</a> HOC(高阶组件)</h2>
<p>首先，高阶组件不是一个组件，而是一个函数，它的参数是一个组件，返回值也是一个组件</p>
<p>高阶组件通过包裹其他组件实现组件状态逻辑的复用</p>
<p>那么上面这个案例通过高阶组件实现：</p>
<div class="language-jsx ext-jsx line-numbers-mode"><pre v-pre class="language-jsx"><code><span class="token keyword">import</span> React <span class="token keyword">from</span> <span class="token string">'react'</span>
...
<p><em>Hook</em> 是 React 16.8 的新增特性。它可以让你在不编写 class 的情况下使用 state 以及其他的 React 特性。<em>Hook</em> 是开创性的，它解决了很多 React 之前的存在的问题，比如 this 指向问题、比如 hoc 的嵌套复杂度问题等等</p>
<p>那么这个例子通过<em>Hook</em> 实现是这样的：</p>
