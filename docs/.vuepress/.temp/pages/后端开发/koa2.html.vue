<template><div><h2 id="koa2-环境搭建-创建项目" tabindex="-1"><a class="header-anchor" href="#koa2-环境搭建-创建项目" aria-hidden="true">#</a> koa2 环境搭建-创建项目</h2>
<p>安装脚手架：<code v-pre>npm i koa-generator -g</code></p>
<p>使用脚手架 <code v-pre>koa-generator</code> 创建 <code v-pre>koa2</code> 项目 ：<code v-pre>koa2 xxx</code></p>
<h2 id="koa2-环境搭建-目录和文件介绍" tabindex="-1"><a class="header-anchor" href="#koa2-环境搭建-目录和文件介绍" aria-hidden="true">#</a> koa2 环境搭建-目录和文件介绍</h2>
<p><code v-pre>app.js</code> 是项目入口文件，其中 <code v-pre>app.use()</code>都是<strong>中间件</strong></p>
<p><code v-pre>bin/www</code> 获取 <code v-pre>app</code> 导出的 <code v-pre>Koa</code> 实例，并且监听 <code v-pre>3000</code> 端口；<strong>其他先不要管知道这个就行了</strong></p>
<p><code v-pre>views</code> 下的 <code v-pre>pug</code> 是服务端模板引擎，<strong>暂时先不用去管</strong>,因为前后端分离，不需要服务端返回页面，只关注<strong>定义路由</strong>，<strong>接口返回 <code v-pre>JSON</code> 数据</strong>就可以</p>
<h2 id="koa2-环境搭建-新建路由" tabindex="-1"><a class="header-anchor" href="#koa2-环境搭建-新建路由" aria-hidden="true">#</a> koa2 环境搭建-新建路由</h2>
<div class="custom-container warning">
<p class="custom-container-title">注意</p>
<p>在 <code v-pre>ctx.body</code> 为对象时，直接返回 <code v-pre>JSON</code> 格式，不需要设置 <code v-pre>Content-type</code>;<code v-pre>koa </code>将 <code v-pre>request</code> 和 <code v-pre>response</code> 对象封装在了一个对象中，该对象就是 <code v-pre>ctx</code></p>
</div>
<ol>
<li>在 <code v-pre>routers</code> 下定义路由文件，可能会有前缀，<strong>不要忘了写<code v-pre>router.prefix('/api')</code></strong></li>
</ol>
...
router<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token string">'/list'</span><span class="token punctuation">,</span> <span class="token keyword">async</span> <span class="token parameter">ctx</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
...
<li>在 <code v-pre>app.js</code> 引用路由</li>
</ol>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> comments <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'./routes/comments'</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ol start="3">
<li>app.js 下注册路由</li>
</ol>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>app<span class="token punctuation">.</span><span class="token function">use</span><span class="token punctuation">(</span>comments<span class="token punctuation">.</span><span class="token function">routes</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">,</span> comments<span class="token punctuation">.</span><span class="token function">allowedMethods</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="koa2-处理-http-请求" tabindex="-1"><a class="header-anchor" href="#koa2-处理-http-请求" aria-hidden="true">#</a> koa2 处理 http 请求</h2>
<p><code v-pre>querystring</code> <code v-pre>Request body</code> <code v-pre>Response body</code> <code v-pre>Content-type</code></p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> router <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'koa-router'</span><span class="token punctuation">)</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
...
module<span class="token punctuation">.</span>exports <span class="token operator">=</span> router <span class="token comment">// 输出</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><strong>Koa 和 node.js 相比，封装了原生代码的 API,规范了流程和格式</strong></p>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="koa2-中间件" tabindex="-1"><a class="header-anchor" href="#koa2-中间件" aria-hidden="true">#</a> koa2 中间件</h2>
<p>中间件：一个流程上，独立的业务模块</p>
<p>可扩展，可插拔</p>
<p>类似于工厂的流水线</p>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/koa2中间件.png" alt="koa2中间件" loading="lazy"></p>
<p>为什么使用中间件？</p>
<ul>
<li>
<p>拆分业务模块，使代码清晰</p>
...
<li>
<p>统一使用中间件，使得各业务代码都规范标准</p>
</li>
<li>
<p>扩展性好，易添加，易删除</p>
</li>
</ul>
<p>koa2 业务代码都是中间件所有的 app.use(...)都是中间件</p>
<p>路由也是中间件（只不过限制了 url 规则），所有的请求都会经过 app.use，路由规则匹配后才会进入对应路由中间件</p>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/koa2中间件2.png" alt="koa2中间件2" loading="lazy"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>模拟登录功能,仅仅是<strong>为了使用中间件</strong></p>
<p>app.js 中使用中间件，next()执行下一个中间件</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/koa2中间件3.png" alt="koa2中间件3" loading="lazy"></p>
<h2 id="koa2-洋葱圈模型" tabindex="-1"><a class="header-anchor" href="#koa2-洋葱圈模型" aria-hidden="true">#</a> koa2 洋葱圈模型</h2>
<div class="custom-container warning">
<p class="custom-container-title">注意</p>
<p>中间件机制，业务模块的划分;洋葱圈模型，中间件的执行机制;两者要分开，不要混为一谈</p>
</div>
<p>中间件机制，是 koa 的精髓，每个中间件都是 <strong>async</strong> 函数，中间件的运行机制，就像<strong>洋葱圈</strong></p>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/洋葱圈模型图示.png" alt="洋葱圈模型图示" loading="lazy"></p>
<p>代码演示：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> Koa <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'koa'</span><span class="token punctuation">)</span>
<span class="token keyword">const</span> app <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Koa</span><span class="token punctuation">(</span><span class="token punctuation">)</span>
...
<p class="custom-container-title">个人理解</p>
<p>遇到了 async 异步函数中的 await，先返回，阻塞了函数中后面代码的执行。去执行下一个中间件，在下一个中间件中又遇到了 await 继续执行下一个中间件....这样到最后一个中间件，逐层向上执行每个 async 函数的后续代码。</p>
</div>
<h2 id="koa2-登录实现方案与实践" tabindex="-1"><a class="header-anchor" href="#koa2-登录实现方案与实践" aria-hidden="true">#</a> koa2 登录实现方案与实践</h2>
<h3 id="cookie-介绍" tabindex="-1"><a class="header-anchor" href="#cookie-介绍" aria-hidden="true">#</a> cookie-介绍</h3>
<ul>
<li>存储在浏览器的一段字符串，最大 5kb</li>
<li>每个域都可有一个 cookie，跨域不共享</li>
<li>格式如 k1=V1；k2=V2；k3=v3（可结构化）</li>
<li>cookie 会随 http 请求传递给服务端</li>
<li>服务端可修改 cookie 再返回给前端</li>
<li>默认，跨域不可传递 cookie</li>
</ul>
<h3 id="cookie-服务端操作-cookie" tabindex="-1"><a class="header-anchor" href="#cookie-服务端操作-cookie" aria-hidden="true">#</a> cookie-服务端操作 cookie</h3>
<ul>
<li>nodejs</li>
</ul>
...
<span class="token keyword">const</span> server <span class="token operator">=</span> http<span class="token punctuation">.</span><span class="token function">createServer</span><span class="token punctuation">(</span><span class="token punctuation">(</span><span class="token parameter">req<span class="token punctuation">,</span> res</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
  ...
  cookieStr<span class="token punctuation">.</span><span class="token function">split</span><span class="token punctuation">(</span><span class="token string">';'</span><span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">forEach</span><span class="token punctuation">(</span><span class="token parameter">cookieItem</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
...
<p>请求登录接口，成功则设置 cookie，如 user=zhangsan</p>
<p>前端再请求其他接口，就会带着上述 cookie</p>
<p>服务端判断 cookie 有无 user=zhangsan，即可验证</p>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/登录校验cookie.png" alt="登录校验cookie" loading="lazy"></p>
<h3 id="session-介绍" tabindex="-1"><a class="header-anchor" href="#session-介绍" aria-hidden="true">#</a> session-介绍</h3>
<p>cookie 不能暴露用户名</p>
<p>cookie 存放用户信息明文，非常危险;解决方案：cookie 存一个用户标识，如 userId=123,<strong>而不是 username=zhangfan</strong></p>
<p>cookie 存储用户标识,用户信息则存储到 session 中,session 即用户信息的存储，和 cookie 有对应关系</p>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/sessioncookie关系.png" alt="sessioncookie关系" loading="lazy"></p>
<h3 id="koa2-实现登录-session" tabindex="-1"><a class="header-anchor" href="#koa2-实现登录-session" aria-hidden="true">#</a> koa2 实现登录-session</h3>
<ol>
<li>安装<code v-pre>koa-generic-session</code>(2.0.4)</li>
</ol>
<div class="language-bash ext-sh line-numbers-mode"><pre v-pre class="language-bash"><code><span class="token function">npm</span> i koa-generic-session <span class="token parameter variable">--save</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ol start="2">
<li>app.js 使用中间件</li>
</ol>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 自动配置了 cookie 和 session</span>
...
app<span class="token punctuation">.</span><span class="token function">use</span><span class="token punctuation">(</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="koa2-实现登录-模拟登录" tabindex="-1"><a class="header-anchor" href="#koa2-实现登录-模拟登录" aria-hidden="true">#</a> koa2 实现登录-模拟登录</h3>
<p>router/users.js</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 模拟登录</span>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 登录（对接数据库的）</span>
...
router<span class="token punctuation">.</span><span class="token function">get</span><span class="token punctuation">(</span><span class="token string">'/login'</span><span class="token punctuation">,</span> <span class="token keyword">async</span> <span class="token punctuation">(</span><span class="token parameter">ctx<span class="token punctuation">,</span> next</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="完善登录功能-重写登录中间件" tabindex="-1"><a class="header-anchor" href="#完善登录功能-重写登录中间件" aria-hidden="true">#</a> 完善登录功能-重写登录中间件</h3>
<p><code v-pre>middlewares/loginCheck.js</code></p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 登录验证的中间件</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>将登录中间件单独用于某个路由(比如获取留言板内容)</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> loginCheck <span class="token operator">=</span> <span class="token function">require</span><span class="token punctuation">(</span><span class="token string">'../middlewares/loginCheck'</span><span class="token punctuation">)</span>
