<template><div><h2 id="剩余参数" tabindex="-1"><a class="header-anchor" href="#剩余参数" aria-hidden="true">#</a> 剩余参数</h2>
<h3 id="剩余参数是什么" tabindex="-1"><a class="header-anchor" href="#剩余参数是什么" aria-hidden="true">#</a> 剩余参数是什么</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="剩余参数的注意事项" tabindex="-1"><a class="header-anchor" href="#剩余参数的注意事项" aria-hidden="true">#</a> 剩余参数的注意事项</h3>
<ol>
<li>箭头函数的剩余参数</li>
</ol>
<p>箭头函数的参数部分即使<strong>只有</strong>剩余参数，也不能省略圆括号</p>
...
<li>
<p>箭头函数可以使用剩余参数替代 arguments 获取实际参数</p>
</li>
<li>
<p>剩余参数的位置：剩余参数<strong>只能是最后一个参数</strong>，之后不能再有其他参数，否则会报错。</p>
</li>
</ol>
<h3 id="与解构赋值结合使用" tabindex="-1"><a class="header-anchor" href="#与解构赋值结合使用" aria-hidden="true">#</a> 与解构赋值结合使用</h3>
<p>剩余参数不一定非要作为函数参数使用：</p>
<ul>
<li>与数组的解构赋值</li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 必须是最后一个</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="数组的展开运算符" tabindex="-1"><a class="header-anchor" href="#数组的展开运算符" aria-hidden="true">#</a> 数组的展开运算符</h2>
<h3 id="数组的展开运算符的基本用法" tabindex="-1"><a class="header-anchor" href="#数组的展开运算符的基本用法" aria-hidden="true">#</a> 数组的展开运算符的基本用法</h3>
<p>eg:求数组中的最小值</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// Math.min()要求参数必须是“罗列出来”，而不能是数组，所以要展开</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="区分剩余参数和展开运算符" tabindex="-1"><a class="header-anchor" href="#区分剩余参数和展开运算符" aria-hidden="true">#</a> 区分剩余参数和展开运算符</h3>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 剩余参数</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>根本区别：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 展开运算符</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>test:下图中标注的三处代码，分别表示什么？</p>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/区分剩余参数和展开运算符test.png" alt="区分剩余参数和展开运算符test" loading="lazy"></p>
<p>1 剩余元素、2 剩余参数、3 展开运算符</p>
<h3 id="数组展开运算符的应用" tabindex="-1"><a class="header-anchor" href="#数组展开运算符的应用" aria-hidden="true">#</a> 数组展开运算符的应用</h3>
<ol>
<li>复制数组</li>
</ol>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="对象的展开运算符" tabindex="-1"><a class="header-anchor" href="#对象的展开运算符" aria-hidden="true">#</a> 对象的展开运算符</h2>
<h3 id="对象展开运算符的基本用法" tabindex="-1"><a class="header-anchor" href="#对象展开运算符的基本用法" aria-hidden="true">#</a> 对象展开运算符的基本用法</h3>
<ol>
<li>展开对象<br>
对象不能直接展开，必须在{}中展开<br>
对象的展开：把属性罗列出来，用顿号分隔，放到一个{}中，构成新对象</li>
</ol>
...
<ul>
<li>如果展开的不是对象，则会自动将其转为对象，再将属性罗列出来</li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 自身转换为对象中没有属性 所有返回空对象</span>
...
<li>如果展开运算符后面是字符串，它会自动转成一个类似数组的对象，因此返回的不是空对象</li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="对象展开运算符的应用" tabindex="-1"><a class="header-anchor" href="#对象展开运算符的应用" aria-hidden="true">#</a> 对象展开运算符的应用</h3>
<ol>
<li>复制对象</li>
</ol>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 浅拷贝</span>
