<template><div><p>// TODO: 2022.5.23 基于ES6入门 class章节重新梳理</p>
<h2 id="class-基本用法" tabindex="-1"><a class="header-anchor" href="#class-基本用法" aria-hidden="true">#</a> Class 基本用法</h2>
<p>类名一般首字母大写</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="属性与方法" tabindex="-1"><a class="header-anchor" href="#属性与方法" aria-hidden="true">#</a> 属性与方法</h2>
<h3 id="实例属性、静态方法和静态属性" tabindex="-1"><a class="header-anchor" href="#实例属性、静态方法和静态属性" aria-hidden="true">#</a> 实例属性、静态方法和静态属性</h3>
<ol>
<li>实例属性</li>
</ol>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">static</span> <span class="token function">speak</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">{</span>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 这是一个最近添加到 JavaScript 的特性,可以在最近的 Chrome 工作</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="私有属性和方法" tabindex="-1"><a class="header-anchor" href="#私有属性和方法" aria-hidden="true">#</a> 私有属性和方法</h3>
<div class="custom-container tip">
<p class="custom-container-title">新提案</p>
<p>这是一个最近添加到 JavaScript 的特性，它为私有属性和方法提供语言级支持。</p>
<p>私有属性和方法应该以 <code v-pre>#</code> 开头。它们只在类的内部可被访问：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Foo</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>上面代码中，<code v-pre>#a,#b</code>为私有属性（必须在类中声明），<code v-pre>#sum()</code>就是一个私有方法。</p>
</div>
<p>私有方法和私有属性，是只能在类的内部访问的方法和属性，外部不能访问。这是常见需求，有利于代码的封装，但 ES6 不提供，只能通过变通方法模拟实现。</p>
<p>模拟私有属性和方法：<code v-pre>_</code>开头表示私有，属性或方法名用下划线开头（业界规定这样的属性或方法表示私有，不应该随意改动，但不具备很强的约束力）</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>将私有属性和方法移出类,从根本上解决问题</p>
...
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>p<span class="token punctuation">.</span><span class="token function">getName</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="存取器" tabindex="-1"><a class="header-anchor" href="#存取器" aria-hidden="true">#</a> 存取器</h2>
...
<p>在 <code v-pre>class</code> 方法中，继承是使用 <code v-pre>extends</code> 关键字来实现的。子类必须在 <code v-pre>constructor()</code>调用 <code v-pre>super()</code>方法，否则新建实例时会报错</p>
<p>报错的原因是：子类是没有自己的 <code v-pre>this</code>对象的，它只能继承自父类的 <code v-pre>this</code> 对象，然后对其进行加工，而<code v-pre>super()</code>就是将父类中的<code v-pre> this</code> 对象继承给子类的。没有 <code v-pre>super</code>，子类就得不到 <code v-pre>this </code>对象。</p>
<p>但是 子类中不写 <code v-pre>constructor</code> 可以不写 <code v-pre>super</code></p>
</div>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
    <span class="token function">constructor</span><span class="token punctuation">(</span><span class="token parameter">name<span class="token punctuation">,</span> sex</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token keyword">this</span><span class="token punctuation">.</span>name <span class="token operator">=</span> name
...
<h4 id="作为函数调用" tabindex="-1"><a class="header-anchor" href="#作为函数调用" aria-hidden="true">#</a> 作为函数调用</h4>
<ul>
<li><code v-pre>super</code> 可以作为函数调用，形式是 <code v-pre>super(参数 1, 参数 2, ...)</code></li>
<li>代表<strong>父类的构造方法</strong>，只能用在子类的构造方法中，用在其他地方就会报错</li>
<li><code v-pre>super</code> 虽然代表了父类的构造方法，但是内部的 this 指向子类的实例</li>
</ul>
<h4 id="作为对象使用" tabindex="-1"><a class="header-anchor" href="#作为对象使用" aria-hidden="true">#</a> 作为对象使用 <Badge text="了解"/></h4>
<p><code v-pre>super</code> 还可以作为对象调用，形式是 <code v-pre>super.函数名()</code></p>
<p>(1) 在构造方法中使用或在一般方法中使用</p>
<ul>
<li>super 代表父类的原型对象 <code v-pre>Person.prototype</code></li>
<li>定义在父类 <code v-pre>constructor</code> 上的方法或属性，是<strong>无法</strong>通过 <code v-pre>super</code> 调用的</li>
<li>通过<code v-pre>super</code>调用<code v-pre>父类</code>的方法时,方法内部的<code v-pre> this</code> 指向<strong>当前的子类实例</strong></li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
    <span class="token function">constructor</span><span class="token punctuation">(</span><span class="token parameter">name<span class="token punctuation">,</span> sex</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token keyword">this</span><span class="token punctuation">.</span>name <span class="token operator">=</span> name
...
<ul>
<li><code v-pre>super</code> 代表的是<strong>父类</strong>，而不是父类的原型对象</li>
<li>通过 <code v-pre>super</code> 调用父类的方法时，父类静态方法内部的 <code v-pre>this</code> 指向当前的子类，而不是子类的实例</li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Person</span> <span class="token punctuation">{</span>
    <span class="token function">constructor</span><span class="token punctuation">(</span><span class="token parameter">name<span class="token punctuation">,</span> sex</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
        <span class="token keyword">this</span><span class="token punctuation">.</span>name <span class="token operator">=</span> name
