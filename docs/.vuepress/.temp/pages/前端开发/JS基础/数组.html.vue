<template><div><h2 id="数组简介和基本使用" tabindex="-1"><a class="header-anchor" href="#数组简介和基本使用" aria-hidden="true">#</a> 数组简介和基本使用</h2>
<h3 id="简介" tabindex="-1"><a class="header-anchor" href="#简介" aria-hidden="true">#</a> 简介</h3>
<p>数组（Array），顾名思义，用来存储组相关的值，从而方便进行求和、计算平均数、逐项遍历等操作。</p>
<h3 id="定义方法" tabindex="-1"><a class="header-anchor" href="#定义方法" aria-hidden="true">#</a> 定义方法</h3>
<ol>
<li>var arr=[1,2,3]</li>
<li>var arr=new Array(1,2,3) //包装类</li>
<li>var arr=new Array(3) // 长度为 3 的数字，每一项都是 undefined</li>
</ol>
<h3 id="访问数组项" tabindex="-1"><a class="header-anchor" href="#访问数组项" aria-hidden="true">#</a> 访问数组项</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="下标越界" tabindex="-1"><a class="header-anchor" href="#下标越界" aria-hidden="true">#</a> 下标越界</h3>
<p>JavaScrip 规定，访问数组中不存在的项会返回 undefined，不会报错</p>
<h3 id="数组的长度" tabindex="-1"><a class="header-anchor" href="#数组的长度" aria-hidden="true">#</a> 数组的长度</h3>
<ul>
<li>数组的 length 属性表示它的长度</li>
<li>数组最后一项的下标是数组的长度减 1</li>
</ul>
<h3 id="更改数组项" tabindex="-1"><a class="header-anchor" href="#更改数组项" aria-hidden="true">#</a> 更改数组项</h3>
<ul>
<li>数组并不是只读的，我们可以修改它其中任何项的值</li>
<li>如果更改的数组项超过了 length-1，则会创造这项</li>
</ul>
<h3 id="数组的遍历" tabindex="-1"><a class="header-anchor" href="#数组的遍历" aria-hidden="true">#</a> 数组的遍历</h3>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> arr <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">2</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">]</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="数组类型的检测" tabindex="-1"><a class="header-anchor" href="#数组类型的检测" aria-hidden="true">#</a> 数组类型的检测</h3>
<ol>
<li>arr instanceof Array // 返回 true</li>
<li>arr.isArray()方法</li>
</ol>
<h2 id="数组的常用方法" tabindex="-1"><a class="header-anchor" href="#数组的常用方法" aria-hidden="true">#</a> 数组的常用方法</h2>
<p><a href="https://juejin.cn/post/6850418121074573320" target="_blank" rel="noopener noreferrer">[7000 字]JavaScript 数组所有方法基础总结<ExternalLinkIcon/></a></p>
<h3 id="数组的头尾操作" tabindex="-1"><a class="header-anchor" href="#数组的头尾操作" aria-hidden="true">#</a> 数组的头尾操作</h3>
<ol>
<li>push()</li>
</ol>
<ul>
<li>push()方法用来在<strong>数组末尾</strong>推入新项，参数就是要推入的项</li>
<li>如果要推入多项，可以用逗号隔开</li>
<li>调用 push()方法后，数组会立即改变，不需要赋值</li>
<li>该方法会返回新的长度</li>
</ul>
<ol start="2">
<li>pop()</li>
...
<ul>
<li>与 push()相反，pop()方法用来删除数组中的<strong>最后一项</strong></li>
<li>pop()方法不仅会删除数组末项，而且会<strong>返回被删除的项</strong></li>
</ul>
<ol start="3">
<li>unshift()</li>
</ol>
<ul>
<li>unshift()方法用来在<strong>数组头部</strong>插入新项，参数就是要插入的项</li>
<li>如果要插入多项，可以用逗号隔开</li>
<li>调用 unshift()方法后，数组会立即改变，不需要赋值</li>
<li>该方法会返回新的长度</li>
</ul>
<ol start="4">
<li>shift()</li>
...
<ul>
<li>与 unshift()相反， shift()方法用来删除数组中<strong>下标为 0</strong>的项</li>
<li>shift()方法不仅会删除数组首项，而且<strong>会返回被删除的项</strong></li>
</ul>
<h3 id="splice" tabindex="-1"><a class="header-anchor" href="#splice" aria-hidden="true">#</a> splice()</h3>
<ul>
<li>splice()方法用于<strong>替换数组中的指定项</strong></li>
</ul>
...
<li>splice()方法可以用于在<strong>指定位置插入新项</strong></li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> arr <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token number">3</span><span class="token punctuation">,</span> <span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">,</span> <span class="token number">4</span><span class="token punctuation">]</span>
...
<li>splice()方法可以用于<strong>删除指定项</strong></li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> arr <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token number">3</span><span class="token punctuation">,</span> <span class="token number">1</span><span class="token punctuation">,</span> <span class="token number">3</span><span class="token punctuation">,</span> <span class="token number">4</span><span class="token punctuation">]</span>
...
<li>splice()方法会以<strong>数组形式</strong>返回被删除的项</li>
</ul>
<h3 id="slice" tabindex="-1"><a class="header-anchor" href="#slice" aria-hidden="true">#</a> slice()</h3>
<ul>
<li>slice()方法返回一个新的数组对象，这一对象是一个由 <code v-pre>begin</code> 和 <code v-pre>end</code> 决定的原数组的<strong>浅拷贝</strong></li>
<li>slice(a,b)截取的子数组从下标为 a 的项开始，到下标为 b（但<strong>不包括下标为 b 的项</strong>）结束</li>
<li>slice(a,b)方法<strong>不会更改原有数组</strong></li>
<li>slice()如果不提供第二个参数，则表示从指定项开始，提取所有后续所有项作为子数组</li>
<li>slice()方法的参数允许为负数，表示<strong>数组的倒数第几项</strong></li>
<li>如果同时省略<code v-pre>begin</code> 和 <code v-pre>end</code>参数，将<strong>返回一个原数组的浅拷贝</strong></li>
</ul>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="join-和-split" tabindex="-1"><a class="header-anchor" href="#join-和-split" aria-hidden="true">#</a> join()和 split()</h3>
<p>数组的 <strong>join()方法可以使数组转为字符串</strong>；字符串的<strong>split()方法可以使字符串转为数组</strong>。</p>
<ul>
<li>join()的参数表示以什么字符作为连接符，如果留空则默认以逗号分隔，如同调用 tostring()方法</li>
<li>split()的参数表示以什么字符拆分字符串，一般不能留空=&gt;(str.split(''))</li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token string">'abcd'</span><span class="token punctuation">.</span><span class="token function">split</span><span class="token punctuation">(</span><span class="token string">''</span><span class="token punctuation">)</span> <span class="token comment">// [ 'a', 'b', 'c', 'd' ]</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>字符串和数组更多相关性</p>
<ul>
<li>字符串也可以使用方括号内写下标的形式，访问某个字符等价于 charAt()方法,意味着字符串可以直接遍历</li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> str <span class="token operator">=</span> <span class="token string">'123456'</span>
...
<p>参数：数组和/或值，将被合并到一个新的数组中。如果没有参数，则 concat 会返回调用此方法的现存数组的一个<strong>浅拷贝</strong></p>
<p>返回值：一个新的数组</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="reverse" tabindex="-1"><a class="header-anchor" href="#reverse" aria-hidden="true">#</a> reverse()</h3>
<p>reverse()方法用来将一个数组中的全部项顺序置反</p>
<h3 id="indexof-和-includes" tabindex="-1"><a class="header-anchor" href="#indexof-和-includes" aria-hidden="true">#</a> indexOf()和 includes()</h3>
<ul>
<li>indexOf()方法的功能是搜索数组中的元素，并返回它所在的位置，如果元素不存在，则返回-1</li>
<li>includes()方法的功能是判断一个数组是否包含一个指定的值，返回布尔值</li>
</ul>
<h2 id="find" tabindex="-1"><a class="header-anchor" href="#find" aria-hidden="true">#</a> find()</h2>
<p><strong><code v-pre>find()</code></strong> 方法返回数组中满足提供的测试函数的第一个元素的值。否则返回 <code v-pre>undefined</code></p>
<p><code v-pre>callback</code>参数：当前遍历到的元素,当前遍历到的索引,数组本身</p>
...
<p>返回值：undefined</p>
<p>callback 被调用时传入三个参数：数组当前项的值，数组当前项的索引，数组对象本身</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> array1 <span class="token operator">=</span> <span class="token punctuation">[</span><span class="token string">'a'</span><span class="token punctuation">,</span> <span class="token string">'b'</span><span class="token punctuation">,</span> <span class="token string">'c'</span><span class="token punctuation">]</span>
...
<p><code v-pre>map()</code>方法的回调函数每次执行后的返回值组合起来形成一个新数组</p>
<p><code v-pre>返回值</code>：<strong>一个由原数组每个元素执行回调函数的结果组成的新数组</strong>。</p>
<p><code v-pre>callback</code> 被调用时传入三个参数：<code v-pre>数组元素</code>，<code v-pre>元素索引</code>，<code v-pre>原数组本身</code>;<code v-pre>callback</code> 每次执行后的返回值（包括 <code v-pre>undefined</code>）组合起来形成一个新数组。</p>
...
<p class="custom-container-title">forEach() 和 map() 的区别</p>
<p><strong>返回值</strong>:forEach()方法返回 undefined ，而 map()返回一个包含已转换元素的新数组</p>
<p><strong>链接其他方法</strong>:map()方法输出可以与其他方法(如 reduce()、sort()、filter())链接在一起，以便在一条语句中执行多个操作。另一方面，forEach()不能与其他方法链接，因为它返回 undefined。</p>
<p><strong>性能</strong>:map()方法比 forEach()转换元素要好。</p>
<p><strong>中断遍历</strong>:这两种方法都不能用 break 中断，否则会引发异常</p>
<p>建议使用 map()转换数组的元素，因为它语法短，可链接且性能更好。</p>
<p>如果不想返回的数组或不转换数组的元素，则使用 forEach() 方法。</p>
<p>最后，<strong>如果要基于某种条件停止或中断数组的遍历，则应使用简单的 for 循环或 for-of / for-in 循环。</strong></p>
<p>参考：<a href="https://blog.csdn.net/weixin_46837985/article/details/112211133" target="_blank" rel="noopener noreferrer">数组中 forEach() 和 map() 的区别<ExternalLinkIcon/></a></p>
</div>
<h3 id="reduce" tabindex="-1"><a class="header-anchor" href="#reduce" aria-hidden="true">#</a> reduce()</h3>
<p>reduce() 方法对数组中的每个元素执行一个由您提供的 <code v-pre>reducer</code> 函数，将其结果汇总为单个返回值。</p>
<p>返回值：<strong>函数累计处理的结果</strong></p>
<p>参数：<code v-pre>reducer</code> 函数,<code v-pre>initialValue</code></p>
<p>reducer 函数接收 4 个参数:</p>
<ul>
<li><code v-pre>previousValue</code> (pre) (上一次调用 reducer 函数的返回值)</li>
<li><code v-pre>currentValue</code> (cur) (数组中正在处理的元素)</li>
<li><code v-pre>currentIndex</code>(idx) (数组中正在处理的元素的索引 )</li>
<li><code v-pre>array</code> (arr) (用于遍历的数组)</li>
</ul>
<p>每一次运行 <code v-pre>reducer</code>函数会将先前元素的计算结果作为参数传入，最后将其结果汇总为单个返回值。</p>
<p><code v-pre>initialValue</code>(可选): 作为第一次调用 <code v-pre>reducer</code>函数时的<code v-pre>previousValue </code>的值。如果没有提供初始值，则将使用数组中的第一个元素,<code v-pre>currentValue</code> 将使用数组第二个元素;若指定了初始值 <code v-pre>initialValue</code>，则 <code v-pre>currentValue</code> 则将使用数组第一个元素</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="sort" tabindex="-1"><a class="header-anchor" href="#sort" aria-hidden="true">#</a> sort()</h3>
<p><code v-pre>特别注意</code>：sort 方法的返回值是<strong>对原数组的<code v-pre>引用</code></strong>。数组在原数组上进行排序，不生成副本。</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><a href="https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Array/sort" target="_blank" rel="noopener noreferrer">Array.prototype.sort()<ExternalLinkIcon/></a></p>
<ul>
<li>升序排序</li>
</ul>
<p><code v-pre>arrObject.sort(function(a,b){return a-b})</code></p>
<p>当 a==b 时，返回值是 0，a 和 b 不用交换位置。</p>
<p>当 a&gt;b 时，返回值大于 0，a 放置在 b 后面。</p>
<p>当 a&lt; b 时，返回值小于 0，a 和 b 不用交换位置。</p>
<ul>
<li>降序排序</li>
</ul>
<p><code v-pre>arrObject.sort(function(a,b){return b-a})</code></p>
<p>当 a==b 时，返回值是 0，a 和 b 不用交换位置。</p>
<p>当 a&gt;b 时，返回值小于 0，a 和 b 不用交换位置。</p>
<p>当 a&lt; b 时，返回值大于 0，a 放置在 b 后面。</p>
...
<p>后面括号中为该方法是否改变原数组</p>
</div>
<ul>
<li>push：用来在数组末尾推入新项（改变）</li>
<li>pop：用来删除数组中的最后一项（改变）</li>
<li>unshift：用来在数组开头插入新项（改变）</li>
<li>shift：用来删除数组中的第一个元素（改变）</li>
<li>splice：用于替换数组中的指定项（改变）</li>
<li>reverse：用来将一个数组中的全部项顺序置反（改变）</li>
<li>slice：用于得到子数组（不改变）</li>
<li>join： 使数组转为字符串（不改变）</li>
<li>concat：合并连接多个数组,<strong>返回一个新的数组</strong>（不改变）</li>
<li>indexOf：搜索数组中的元素，并返回它所在的位置（不改变）</li>
<li>includes：判断一个数组是否包含一个指定的值（不改变）</li>
<li>sort: 在原数组上进行排序，<strong>不生成副本</strong>（改变）</li>
<li>fifter: <strong>创建一个新数组</strong>, 其包含通过所提供函数实现的测试的所有元素（不改变）</li>
<li>forEach: 对数组的每个元素执行一次给定的函数,<strong>返回值为 undefined</strong>（不改变:<code v-pre>forEach</code> 不会直接改变调用它的对象，但是那个对象可能会被 <code v-pre>callback</code> 函数改变）</li>
<li>map: <strong>创建一个新数组</strong>, 新数组中的元素是原数组中的<strong>每个元素调用一次提供的函数后的返回值</strong>（不改变）</li>
<li>reduce: 对数组中的每个元素执行一个由您提供的 reducer 函数(升序执行)，将其结果<strong>汇总为单个返回值</strong>（不改变）</li>
</ul>
<h2 id="数组相关算法" tabindex="-1"><a class="header-anchor" href="#数组相关算法" aria-hidden="true">#</a> 数组相关算法</h2>
<h3 id="数组遍历" tabindex="-1"><a class="header-anchor" href="#数组遍历" aria-hidden="true">#</a> 数组遍历</h3>
<ul>
<li>求数组的和，平均数</li>
<li>求数组的最大值，最小值</li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 求数组的最大值，最小值</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="数组去重" tabindex="-1"><a class="header-anchor" href="#数组去重" aria-hidden="true">#</a> 数组去重</h3>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 算法思路：准备一个空数组，遍历原数组，如果遍历到的项不在结果数组内，则推入结果数组</span>
...
<span class="token punctuation">}</span>
console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>result<span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="随机样本" tabindex="-1"><a class="header-anchor" href="#随机样本" aria-hidden="true">#</a> 随机样本</h3>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 算法思路：准备一个空数组，遍历原数组，随机选择一项，推入结果数组，并且将这项删除</span>
...
<p>冒洵排序的核心思路是<strong>一趟一趟地进行多次项的两两比较</strong>每次都会将最小的元素排好位置，如同水中的气泡上浮一样</p>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/冒泡排序1.png" alt="冒泡排序1" loading="lazy">
<img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/冒泡排序2.png" alt="冒泡排序2" loading="lazy">
<img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/冒泡排序3.png" alt="冒泡排序3" loading="lazy"></p>
...
<li>4 个数字，共需要比较 3 趟，比较次数为 3+2+1=6 次</li>
<li>n 个数字，共需要比较 n-1 趟，比较次数为 n（n-1）/2 次。</li>
</ul>
<h2 id="二维数组" tabindex="-1"><a class="header-anchor" href="#二维数组" aria-hidden="true">#</a> 二维数组</h2>
<p>以数组作为数组元素的数组，即“数组的数组“</p>
</div></template>
