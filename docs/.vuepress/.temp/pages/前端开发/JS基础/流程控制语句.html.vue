...
<h3 id="if-语句-一般和-else-一起使用" tabindex="-1"><a class="header-anchor" href="#if-语句-一般和-else-一起使用" aria-hidden="true">#</a> if 语句(一般和 else 一起使用)</h3>
<ul>
<li>表示如果...就...否则...</li>
<li>在 if 语句中，else 是可以省略的</li>
</ul>
...
<li>如果 if 语句体中只有一行语句，可以省略大括号和换行</li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">if</span> <span class="token punctuation">(</span><span class="token punctuation">(</span>a <span class="token operator">=</span> <span class="token number">1</span><span class="token punctuation">)</span><span class="token punctuation">)</span> console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token string">'a=1'</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h4 id="if-else-if-多条件分支" tabindex="-1"><a class="header-anchor" href="#if-else-if-多条件分支" aria-hidden="true">#</a> if...else...if 多条件分支</h4>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/if-else-if.png" alt="if-else-if" loading="lazy"></p>
<h4 id="if-语句的嵌套" tabindex="-1"><a class="header-anchor" href="#if-语句的嵌套" aria-hidden="true">#</a> if 语句的嵌套</h4>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/游乐园门票.png" alt="游乐园门票" loading="lazy"></p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> <span class="token function-variable function">Price</span> <span class="token operator">=</span> <span class="token keyword">function</span> <span class="token punctuation">(</span><span class="token parameter">age<span class="token punctuation">,</span> day</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
<p>switch 语句的用途：当一个变量被分类讨论的情形。</p>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/swtich语句-if.png" alt="swtich语句-if" loading="lazy"></p>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/使用switch语句.png" alt="使用switch语句" loading="lazy"></p>
<ul>
<li>在 switch()的圆括号中一般是一个变量名，这个变量将被分类讨论</li>
<li>case 表示“情况”，它后面没有圆括号，直接跟一个值。程序会依次将 case 后面的值与 switch 圆括号中的值进行全等比对，如果比对相同，则执行这条 case 冒号后面的语句。</li>
<li>default 表示默认情况。</li>
<li>多条 case 可以共用同一个语句体。</li>
<li>switch 语句并不像 if 语句那样当执行了某一个分支之后会自动跳出 if 语句体，程序员必须主动调用 break 来跳出 switch 语句体。如果不书写 break，则后面的所有 case 都将被视为匹配，直到遇见 break。</li>
</ul>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/直到遇到break.png" alt="直到遇到break" loading="lazy"></p>
<h3 id="三元运算符" tabindex="-1"><a class="header-anchor" href="#三元运算符" aria-hidden="true">#</a> 三元运算符</h3>
<p>条件表达式？表达式 1：表达式 2</p>
<p>问号前面是判断的条件，问号后面用冒号隔开两个表达式。当条件表达式为真时调用表达式 1，为假时调用表达式 2。</p>
<p>三元运算符的用途：根据某个条件是否成立，在两个不同值中选择变量的值</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> age <span class="token operator">=</span> <span class="token number">18</span>
...
<h5 id="for-语句的执行机理" tabindex="-1"><a class="header-anchor" href="#for-语句的执行机理" aria-hidden="true">#</a> for 语句的执行机理</h5>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/for语句的执行机理.png" alt="for语句的执行机理" loading="lazy"></p>
...
<h4 id="for-循环的高级用法" tabindex="-1"><a class="header-anchor" href="#for-循环的高级用法" aria-hidden="true">#</a> for 循环的高级用法</h4>
<p>语法：label : statement</p>
<p>①label 表示标签名</p>
<p>②statement 表示代码块</p>
<p>③label 标签名与 statement 表示代码块之间使用英文状态下的冒号分隔</p>
<p>定义的标签可以在将来由 break 或 continue 语句引用。</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> num <span class="token operator">=</span> <span class="token number">0</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>在这种情况下，continue 语句会强制继续执行循环，即退出内部循环，执行外部循环。当 j 是 5 时，continue 语句执行，而这也就意味着内部循环少执行了 5 次，因此 num 的结果是 95。</p>
<h3 id="while" tabindex="-1"><a class="header-anchor" href="#while" aria-hidden="true">#</a> while</h3>
<ul>
<li>while 语句，是一种“不定范围”循环.</li>
<li>While 语句事先不指定循环开始、结束的范围，只要测试条件满足，就一直执行循环体</li>
<li>while 循环没有显式定义循环变量，必须自己在 while 循环外先定义好循环变量，有时甚至可以没有循环变量。</li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> n <span class="token operator">=</span> <span class="token number">1</span>
...
<li>循环体内的语句，必须使循环测试条件趋向不成立，否则会死循环</li>
<li>一定要注意“出一”错误
小兔子拔萝卜，第 1 天拔 1 个，第 2 天拔 2 个，第 3 天拔 3 个问：第几天能拔光 500 个萝卜？</li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> sum <span class="token operator">=</span> <span class="token number">0</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="break-continue" tabindex="-1"><a class="header-anchor" href="#break-continue" aria-hidden="true">#</a> break,continue</h3>
<ul>
<li>break 表示立即终止循环，它只能用在循环语句中，在 for 循环和 while 循环中都可以使用
<img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/break-1.png" alt="break-1" loading="lazy"></li>
<li>break 用在 while 语句中，通常和 While（true）{}搭配使用
<img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/break-2.png" alt="break-2" loading="lazy">
<blockquote>
<p>while(true){}是一个死循环，通过 break 可以让它终止循环。</p>
</blockquote>
</li>
<li>continue 用于跳过循环中的一个迭代，并继续执行循环中的下一个迭代。
<img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/continue.png" alt="continue" loading="lazy"></li>
</ul>
<h3 id="do-while" tabindex="-1"><a class="header-anchor" href="#do-while" aria-hidden="true">#</a> do...while</h3>
<ul>
<li>do while 循环是一种“后测试循环语句”。它不同于 for 循环和 While 循环每次都是“先测试条件是否满足，然后执行循环体″，do- While 循环是“先执行循环体，然后测试条件是否满足</li>
</ul>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/dowhile.png" alt="dowhile" loading="lazy"></p>
<ul>
<li>do- while 循环将循环执行条件写到了循环体的后面，这样一来，循环体一定会至少执行一次，然后再检测循环执行条件是否为 true，决定是否继续执行循环体。</li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> i <span class="token operator">=</span> <span class="token number">11</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="随机数函数" tabindex="-1"><a class="header-anchor" href="#随机数函数" aria-hidden="true">#</a> 随机数函数</h4>
...
<p>Math.random()返回介于 0（包含） ~ 1（不包含） 之间的一个随机数</p>
<p>如果想要得到[a,b]区间的整数，公式</p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>eg：请编写程序，随机生成两个变量 dx 和 dy，它们均在【-4,4】
区间随机取值，但要求 dx 和 dy 不能同时为 0</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> a <span class="token operator">=</span> <span class="token operator">-</span><span class="token number">4</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="_3-种循环对比" tabindex="-1"><a class="header-anchor" href="#_3-种循环对比" aria-hidden="true">#</a> 3 种循环对比</h3>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/3循环对比.png" alt="3循环对比" loading="lazy"></p>
<h2 id="拓展案例" tabindex="-1"><a class="header-anchor" href="#拓展案例" aria-hidden="true">#</a> 拓展案例</h2>
<h3 id="累加器累乘器" tabindex="-1"><a class="header-anchor" href="#累加器累乘器" aria-hidden="true">#</a> 累加器累乘器</h3>
<p>【某大厂面试题】圆周率 π 可以由下面的莱布尼茨级数公式计算出来，请由用户输入参数 n，计算圆周率 π
<img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/莱布尼茨.png" alt="莱布尼茨" loading="lazy"></p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 累加器 就是最后的答案</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="穷举法" tabindex="-1"><a class="header-anchor" href="#穷举法" aria-hidden="true">#</a> 穷举法</h3>
<h4 id="寻找全部的水仙花数" tabindex="-1"><a class="header-anchor" href="#寻找全部的水仙花数" aria-hidden="true">#</a> 寻找全部的水仙花数</h4>
<ol>
<li>遍历所有的 3 位数</li>
<li>把数字转换为字符串进行拆位，可以利用字符串的方法：charAt()方法</li>
<li>利用 if 进行条件匹配，输出结果</li>
</ol>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">var</span> i <span class="token operator">=</span> <span class="token number">100</span><span class="token punctuation">;</span> i <span class="token operator">&lt;</span> <span class="token number">1000</span><span class="token punctuation">;</span> i<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="循环嵌套" tabindex="-1"><a class="header-anchor" href="#循环嵌套" aria-hidden="true">#</a> 循环嵌套</h3>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/循环的嵌套.png" alt="循环的嵌套" loading="lazy"></p>
<h4 id="寻找-1-100-的所有质数" tabindex="-1"><a class="header-anchor" href="#寻找-1-100-的所有质数" aria-hidden="true">#</a> 寻找 1-100 的所有质数</h4>
<p>质数：只能够被 1 和它本身整除的数字，最小的质数是 2</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token literal-property property">outer</span><span class="token operator">:</span> <span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">var</span> i <span class="token operator">=</span> <span class="token number">2</span><span class="token punctuation">;</span> i <span class="token operator">&lt;=</span> <span class="token number">100</span><span class="token punctuation">;</span> i<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
  ...
  console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span>i<span class="token punctuation">)</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h4 id="鸡兔同笼" tabindex="-1"><a class="header-anchor" href="#鸡兔同笼" aria-hidden="true">#</a> 鸡兔同笼</h4>
<p>假设鸡有 a 只，兔有 b 只</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">for</span> <span class="token punctuation">(</span><span class="token keyword">var</span> a <span class="token operator">=</span> <span class="token number">0</span><span class="token punctuation">;</span> a <span class="token operator">&lt;=</span> <span class="token number">35</span><span class="token punctuation">;</span> a<span class="token operator">++</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
