...
<p>BOM（ Browser Object Model，浏览器对象模型）是 Js 与浏览器窗口交互的接口</p>
<h2 id="window-对象" tabindex="-1"><a class="header-anchor" href="#window-对象" aria-hidden="true">#</a> window 对象</h2>
<p>window 对象是当前 JS 脚本运行所处的窗口，而这个窗口中包含 DOM 结构， window.document 属性就是 document 对象</p>
<p>在有标签页功能的浏览器中，每个标签都拥有自己的 window 对象；也就是说，同一个窗口的标签页之间不会共享一个 window 对象</p>
<h3 id="全局变量是-window-的属性" tabindex="-1"><a class="header-anchor" href="#全局变量是-window-的属性" aria-hidden="true">#</a> 全局变量是 window 的属性</h3>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/全局变量window.png" alt="全局变量window" loading="lazy"></p>
<p>这就意味着，多个 js 文件之间是共享全局作用域的，即 s 文件没有作用域</p>
<h3 id="内置函数普遍是-window-的方法" tabindex="-1"><a class="header-anchor" href="#内置函数普遍是-window-的方法" aria-hidden="true">#</a> 内置函数普遍是 window 的方法</h3>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/内置函数普遍是 window的方法.png" alt="内置函数普遍是 window的方法" loading="lazy"></p>
<h3 id="窗口尺寸相关属性" tabindex="-1"><a class="header-anchor" href="#窗口尺寸相关属性" aria-hidden="true">#</a> 窗口尺寸相关属性</h3>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/窗口尺寸相关属性.png" alt="窗口尺寸相关属性" loading="lazy"></p>
<blockquote>
<p>document.documentElement 是一个会返回文档对象（document）的根元素的只读属性（如 HTML 文档的 html 元素）。</p>
</blockquote>
<h3 id="resize-事件" tabindex="-1"><a class="header-anchor" href="#resize-事件" aria-hidden="true">#</a> resize 事件</h3>
<p>在窗口大小改变之后，就会触发 resize 事件，可以使用 window.onresize window.addEventListener
来绑定事件处理函数</p>
<h3 id="已卷动高度" tabindex="-1"><a class="header-anchor" href="#已卷动高度" aria-hidden="true">#</a> 已卷动高度</h3>
<ul>
<li>window.scrollY 属性表示在垂直方向已滚动的像素值</li>
</ul>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/已卷动高度.png" alt="已卷动高度" loading="lazy"></p>
<ul>
<li>document.documentElement.scrollTop 属性也表示窗口卷动高度</li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">var</span> scrollTop <span class="token operator">=</span> window<span class="token punctuation">.</span>scrollY <span class="token operator">||</span> document<span class="token punctuation">.</span>documentElement<span class="token punctuation">.</span>scrollTop
<span class="token comment">// 浏览器兼容性考虑</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>document.documentElement.scrollTop<strong>不是</strong>只读的，而 window.scrollY 是<strong>只读</strong>的</p>
<h3 id="scroll-事件" tabindex="-1"><a class="header-anchor" href="#scroll-事件" aria-hidden="true">#</a> scroll 事件</h3>
<p>在窗口被卷动之后，就会触发 scroll 事件，可以使用 window.onscroll 或者 window.addEventListener 来绑定事件处理函数</p>
<h2 id="navigator-对象" tabindex="-1"><a class="header-anchor" href="#navigator-对象" aria-hidden="true">#</a> Navigator 对象</h2>
<p>window.navigator 属性可以检索 navigator 对象，它内部含有用户此次活动的浏览器的相关属性和标识</p>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/Navigator对象.png" alt=" Navigator对象" loading="lazy"></p>
<h3 id="识别用户浏览器品牌" tabindex="-1"><a class="header-anchor" href="#识别用户浏览器品牌" aria-hidden="true">#</a> 识别用户浏览器品牌</h3>
<p>识别用户浏览器品牌通常使用 naviator.userAgent 属性</p>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/识别浏览器品牌.png" alt="识别用户浏览器品牌" loading="lazy"></p>
<h2 id="history-对象" tabindex="-1"><a class="header-anchor" href="#history-对象" aria-hidden="true">#</a> History 对象</h2>
<p>window.history 对象提供了操作<strong>浏览器会话历史</strong>的接口</p>
<p>模拟浏览器回退按钮</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>history<span class="token punctuation">.</span><span class="token function">back</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token comment">//等同于浏览器的后退按钮</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="location-对象" tabindex="-1"><a class="header-anchor" href="#location-对象" aria-hidden="true">#</a> Location 对象</h2>
<p>window.location 标识当前所在网址，可以通过给这个属性赋值命令浏览器进行页面跳转</p>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/Location对象.png" alt="Location对象" loading="lazy"></p>
<h3 id="重新加载当前页面" tabindex="-1"><a class="header-anchor" href="#重新加载当前页面" aria-hidden="true">#</a> 重新加载当前页面</h3>
<p>可以调用 location 的 reload 方法以重新加载当前页面，参数 true 表示强制从服务器强制加载</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>window<span class="token punctuation">.</span>location<span class="token punctuation">.</span><span class="token function">reload</span><span class="token punctuation">(</span><span class="token boolean">true</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="get-请求查询参数" tabindex="-1"><a class="header-anchor" href="#get-请求查询参数" aria-hidden="true">#</a> GET 请求查询参数</h3>
<p>window.location.search 属性即为当前浏览器的 GET 请求查询参数</p>
<p><img src="https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/get请求参数.png" alt="get请求参数" loading="lazy"></p>
<h2 id="bom-特效" tabindex="-1"><a class="header-anchor" href="#bom-特效" aria-hidden="true">#</a> BOM 特效</h2>
<h3 id="返回顶部" tabindex="-1"><a class="header-anchor" href="#返回顶部" aria-hidden="true">#</a> 返回顶部</h3>
<p>固定定位 定时器</p>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="楼层导航" tabindex="-1"><a class="header-anchor" href="#楼层导航" aria-hidden="true">#</a> 楼层导航</h3>
<ul>
<li>DOM 元素都有<strong>offsetTop</strong>属性(HTMLElement.offsetTop)，表示此元素到定位祖先元素的垂直距离</li>
<li>定位祖先元素：在祖先中，离自己最近的且拥有定位属性的元素，若祖先都不符合条件，offsetParent 为<strong>body</strong></li>
<li>利用 scrollTo 实现 smooth(平滑滚动)</li>
</ul>
