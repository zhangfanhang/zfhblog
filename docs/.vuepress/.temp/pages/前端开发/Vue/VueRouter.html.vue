...
<p>版本：<code v-pre>Vue Router 3.x</code></p>
<p><a href="https://juejin.cn/post/6844903665388486664" target="_blank" rel="noopener noreferrer">可能比文档还详细--VueRouter完全指北<ExternalLinkIcon/></a></p>
</div>
<h2 id="简介" tabindex="-1"><a class="header-anchor" href="#简介" aria-hidden="true">#</a> 简介</h2>
<p><code v-pre>vue-router</code>和<code v-pre>vue</code>是深度集成的,用于单页面应用</p>
<p>传统的路由是用一些超链接来实现页面切换和跳转,而<code v-pre>vue-router</code>在单页面应用(SPA)中,则是组件之间的切换</p>
<p>其本质就是:<strong>建立并管理<code v-pre>url</code>和对应组件之间的映射关系</strong></p>
<p>一个路由<code v-pre>route</code>就是一组映射关系（<code v-pre>key</code> ==&gt;<code v-pre> value</code>）</p>
<h3 id="对-spa-应用的理解" tabindex="-1"><a class="header-anchor" href="#对-spa-应用的理解" aria-hidden="true">#</a> 对 SPA 应用的理解</h3>
<p>单页面应用（<code v-pre>single page web application</code> ,<code v-pre>SPA</code>):整个页面只有一个完整的页面;点击页面中的导航链接不会刷新页面,只会做页面的局部刷新</p>
<h3 id="路由分类" tabindex="-1"><a class="header-anchor" href="#路由分类" aria-hidden="true">#</a> 路由分类</h3>
<h4 id="后端路由" tabindex="-1"><a class="header-anchor" href="#后端路由" aria-hidden="true">#</a> 后端路由</h4>
<p>(1) 理解：<code v-pre>value</code>是<code v-pre> function</code>, 用于处理客户端提交的请求</p>
...
<p>(1) 理解:<code v-pre>value</code> 是<code v-pre> component</code>，用于展示页面内容</p>
<p>(2) 工作过程：当浏览器的路径改变时, 对应的组件就会显示</p>
<h2 id="基本使用" tabindex="-1"><a class="header-anchor" href="#基本使用" aria-hidden="true">#</a> 基本使用</h2>
<ol>
<li>
<p>安装<code v-pre>vue-router</code>，命令：<code v-pre>npm i vue-router</code></p>
</li>
<li>
<p>创建文件：<code v-pre>src/router/index.js</code></p>
</li>
</ol>
...
<li>在<code v-pre>main.js</code>中创建<code v-pre>vm</code>时传入<code v-pre>router</code>配置项</li>
</ol>
...
<p class="custom-container-title">关于/的说明</p>
<p>经过本人测试在<code v-pre>router-link</code>的<code v-pre>to</code>属性路径<code v-pre>path</code>前面无论加不加<code v-pre>/</code>均可完成跳转，但为了避免造成不必要的困惑，请始终添加<code v-pre>/</code></p>
</div>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code>// active-class设置链接激活时使用的CSS类名
...
<h3 id="几个注意点" tabindex="-1"><a class="header-anchor" href="#几个注意点" aria-hidden="true">#</a> 几个注意点</h3>
<div class="custom-container warning">
<p class="custom-container-title">router,routes,route 傻傻分不清?</p>
<ul>
<li><code v-pre>router</code>:一般指的就是路由实例.如$router</li>
<li><code v-pre>routes</code>:指 router 路由实例的 routes API.用来配置多个 route 路由对象</li>
<li><code v-pre> route</code>:指的就是路由对象.例如;$route 指的就是当前路由对象.</li>
</ul>
</div>
<ol>
<li>
<p>路由组件通常存放在<code v-pre>views</code>文件夹，一般组件通常存放在<code v-pre>components</code>文件夹</p>
</li>
<li>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>  <span class="token function">mounted</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token string">'about组件被挂载了'</span><span class="token punctuation">)</span>
    console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token keyword">this</span><span class="token punctuation">)</span>
  <span class="token punctuation">}</span><span class="token punctuation">,</span>
  <span class="token function">beforeDestroy</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token punctuation">{</span>
    console<span class="token punctuation">.</span><span class="token function">log</span><span class="token punctuation">(</span><span class="token string">'about组件被销毁了'</span><span class="token punctuation">)</span>
  <span class="token punctuation">}</span><span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
<li>
<p>每个组件都有自己的<code v-pre>$route</code>属性，里面存储着自己的路由信息,可以通过<code v-pre>this.$route</code>获取</p>
</li>
<li>
<p>整个应用只有一个<code v-pre>router</code>（路由实例:路由实例可以包含多个路由对象.它们是父子包含关系），可以通过<code v-pre>this.$router</code>属性获取到<code v-pre>router</code>实例</p>
</li>
</ol>
<h2 id="动态路由匹配" tabindex="-1"><a class="header-anchor" href="#动态路由匹配" aria-hidden="true">#</a> 动态路由匹配</h2>
<p>我们经常需要把某种模式匹配到的所有路由，全都映射到同个组件。例如，我们有一个 <code v-pre>User</code> 组件，对于所有 <code v-pre>ID</code> 各不相同的用户，都要使用这个组件来渲染。那么，我们可以在 <code v-pre>vue-router</code> 的路由路径中使用“动态路径参数”(dynamic segment) 来达到这个效果：</p>
...
<span class="token keyword">const</span> router <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">VueRouter</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">]</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>现在呢，像 <code v-pre>/user/foo</code> 和 <code v-pre>/user/bar</code> 都将映射到相同的路由。</p>
<p>一个“路径参数”使用冒号 <code v-pre>:</code> 标记。当匹配到一个路由时，参数值会被设置到 <code v-pre>this.$route.params</code>，可以在每个组件内使用。</p>
<table username:="" evan,="" post_id:="" 123="">
<thead>
<tr>
...
<h3 id="响应路由参数的变化" tabindex="-1"><a class="header-anchor" href="#响应路由参数的变化" aria-hidden="true">#</a> 响应路由参数的变化</h3>
<p>从 <code v-pre>/user/foo</code> 导航到 <code v-pre>/user/bar</code>，<strong>原来的组件实例会被复用</strong>。因为两个路由都渲染同个组件，比起销毁再创建，复用则显得更加高效。<strong>不过，这也意味着组件的生命周期钩子不会再被调用</strong>。</p>
<p>复用组件时，想对路由参数的变化作出响应的话，你可以简单地 watch (监测变化) <code v-pre>$route</code> 对象：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> User <span class="token operator">=</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="捕获所有路由或-404-not-found-路由" tabindex="-1"><a class="header-anchor" href="#捕获所有路由或-404-not-found-路由" aria-hidden="true">#</a> 捕获所有路由或 404 Not found 路由</h3>
<p>当我们将<code v-pre>path</code>设为<code v-pre>*</code>，会匹配所有的路径，比较常见的场景是在 404 页面进行使用</p>
<p>假设此时我们有 3 个页面：<code v-pre>index</code>,<code v-pre>about</code>,<code v-pre>404</code></p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> router <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">Router</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
    <span class="token literal-property property">routes</span><span class="token operator">:</span> <span class="token punctuation">[</span>
        ...
        <span class="token punctuation">{</span> <span class="token literal-property property">path</span><span class="token operator">:</span> <span class="token string">'*'</span><span class="token punctuation">,</span> <span class="token literal-property property">component</span><span class="token operator">:</span> <span class="token number">404</span> <span class="token punctuation">}</span><span class="token punctuation">,</span> <span class="token comment">//这个意思就是如果浏览器地址栏输入的不是'/index'也不是'/about'，那我就让它跳转到'404'页面</span>
    <span class="token punctuation">]</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="路由的-params-参数" tabindex="-1"><a class="header-anchor" href="#路由的-params-参数" aria-hidden="true">#</a> 路由的 params 参数</h3>
<ol>
<li>
...
<p>路由携带<code v-pre>params</code>参数时，若使用<code v-pre>to</code>的对象写法，则<strong>不能使用<code v-pre>path</code>配置项</strong>，必须使用<code v-pre>name</code>配置;<code v-pre>query</code>的话,<code v-pre>name</code>和<code v-pre>path</code>均可</p>
</div>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code><span class="token comment">&lt;!-- 跳转并携带params参数，to的字符串写法 --></span>
...
<h3 id="路由的-query-参数" tabindex="-1"><a class="header-anchor" href="#路由的-query-参数" aria-hidden="true">#</a> 路由的 query 参数</h3>
<div class="custom-container tip">
<p class="custom-container-title">扩展阅读:params 和 query 的区别</p>
<p><a href="https://juejin.cn/post/6844903510719348749" target="_blank" rel="noopener noreferrer">vue router 如何使用 params query 传参，以及有什么区别<ExternalLinkIcon/></a></p>
<p><a href="https://juejin.cn/post/7045875372553928740" target="_blank" rel="noopener noreferrer">Vue Router 的 params 和 query 的区别<ExternalLinkIcon/></a></p>
</div>
<ol>
<li>
<p>传递参数</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span> 跳转并携带query参数，to的字符串写法 <span class="token operator">--</span><span class="token operator">></span>
...
<div class="custom-container warning">
<p class="custom-container-title">嵌套路由的两个要点</p>
<ul>
<li>
<p>路由对象中通过<code v-pre>children</code>配置子级路由</p>
</li>
<li>
<p>组件内<code v-pre>router-view</code>的使用</p>
</li>
</ul>
</div>
<ol>
<li>配置路由规则，使用<code v-pre>children</code>配置项：</li>
</ol>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token literal-property property">routes</span><span class="token operator">:</span> <span class="token punctuation">[</span>
    ...
    <span class="token punctuation">{</span>
        ...
        <span class="token literal-property property">children</span><span class="token operator">:</span> <span class="token punctuation">[</span>
            ...
            <span class="token punctuation">{</span>
                <span class="token literal-property property">path</span><span class="token operator">:</span> <span class="token string">'news'</span><span class="token punctuation">,</span> 
              <span class="token comment">// 此时path等同于'/home/news',子路由会继承父路由的路径.但是不能写成path:'/news'.因为以 / 开头的嵌套路径会被当作根路径,也就是说此时news成了根路径.而不是home.</span>
...
<p class="custom-container-title">注意</p>
<p>如果<code v-pre>/home</code>下没有匹配到其他子路由时,<code v-pre>home</code>的<code v-pre>router-view</code>是什么都不会显示的,如果你想让它显示点什么:可以将<code v-pre>home</code>的某一子级路由的<code v-pre>path</code>,设为空<code v-pre>''</code>. 它所配置的组件就是默认显示的组件</p>
<p><strong>利用重定向解决</strong>:重定向其实就是通过路由拦截<code v-pre>path</code>,然后替换<code v-pre>url</code>跳转到<code v-pre>redirect</code>所指定的路由上. 重定向是通过<code v-pre> routes</code> 配置来完成，可以给父组件设置重定向到任意子路由，也可以解决一打开什么也没有显示的问题</p>
<details class="custom-container details"><summary>参考代码</summary>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">//从 /a 重定向到 /b</span>
<span class="token keyword">const</span> router <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">VueRouter</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
...
<span class="token comment">///从 /a 重定向到 命名为'foo'的路由</span>
<span class="token keyword">const</span> router <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">VueRouter</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
...
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>router-link</span> <span class="token attr-name">:to</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>{path:'/home/news'}<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>News<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>router-link</span><span class="token punctuation">></span></span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div></li>
</ol>
<h2 id="编程式的导航" tabindex="-1"><a class="header-anchor" href="#编程式的导航" aria-hidden="true">#</a> 编程式的导航</h2>
<ol>
<li>
<p>作用：不借助<code v-pre>&lt;router-link&gt; </code>实现路由跳转，让路由跳转更加灵活</p>
</li>
<li>
<p>具体编码：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 这个方法会向 history 栈添加一个新的记录，所以，当用户点击浏览器后退按钮时，则回到之前的 URL。</span>
<span class="token comment">//  当你点击 &lt;router-link> 时，这个方法会在内部调用，所以说，点击 &lt;router-link :to="..."> 等同于调用 router.push(...)</span>
...
<span class="token keyword">this</span><span class="token punctuation">.</span>$router<span class="token punctuation">.</span><span class="token function">push</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token comment">// 跟 router.push 很像，唯一的不同就是，它不会向 history 添加新记录，而是跟它的方法名一样 —— 替换掉当前的 history 记录</span>
<span class="token keyword">this</span><span class="token punctuation">.</span>$router<span class="token punctuation">.</span><span class="token function">replace</span><span class="token punctuation">(</span><span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token keyword">this</span><span class="token punctuation">.</span>$router<span class="token punctuation">.</span><span class="token function">forward</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token comment">//在浏览器记录中前进一步 等同于router.go(1)</span>
<span class="token keyword">this</span><span class="token punctuation">.</span>$router<span class="token punctuation">.</span><span class="token function">back</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token comment">//后退一步记录 等同于router.go(-1)</span>
<span class="token keyword">this</span><span class="token punctuation">.</span>$router<span class="token punctuation">.</span><span class="token function">go</span><span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token comment">//可前进也可后退 传数字 负数后退几步 正数前进几步</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div></li>
</ol>
...
<li>
<p>简化跳转：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token operator">&lt;</span><span class="token operator">!</span><span class="token operator">--</span>简化前，需要写完整的路径 <span class="token operator">--</span><span class="token operator">></span>
...
<h2 id="命名视图" tabindex="-1"><a class="header-anchor" href="#命名视图" aria-hidden="true">#</a> 命名视图</h2>
<p>有时候想同时 (同级) 展示多个视图，而不是嵌套展示，例如创建一个布局，有 <code v-pre>sidebar</code> (侧导航) 和 <code v-pre>main</code> (主内容) 两个视图，这个时候命名视图就派上用场了。你可以在界面中拥有多个单独命名的视图，而不是只有一个单独的出口。如果 <code v-pre>router-view</code> 没有设置名字，那么默认为 <code v-pre>default</code></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>一个视图使用一个组件渲染，因此对于同个路由，多个视图就需要多个组件。确保正确使用 <code v-pre>components</code> 配置 (带上 s)：</p>
    ...
    <span class="token literal-property property">routes</span><span class="token operator">:</span> <span class="token punctuation">[</span>
        <span class="token punctuation">{</span>
            ...
            <span class="token literal-property property">components</span><span class="token operator">:</span> <span class="token punctuation">{</span>
                ...
                <span class="token literal-property property">b</span><span class="token operator">:</span> Baz<span class="token punctuation">,</span>
            <span class="token punctuation">}</span><span class="token punctuation">,</span>
        <span class="token punctuation">}</span><span class="token punctuation">,</span>
    <span class="token punctuation">]</span><span class="token punctuation">,</span>
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="路由组件传参" tabindex="-1"><a class="header-anchor" href="#路由组件传参" aria-hidden="true">#</a> 路由组件传参</h2>
<p>在组件中使用 <code v-pre>$route</code> 会使之与其对应路由形成高度<strong>耦合</strong>(耦合指的是各个模块依赖程度)，从而使组件只能在某些特定的 <code v-pre>URL</code> 上使用，限制了其灵活性,可以使用 <code v-pre>props</code> 将组件和路由解耦</p>
<h3 id="路由的-props-配置" tabindex="-1"><a class="header-anchor" href="#路由的-props-配置" aria-hidden="true">#</a> 路由的 props 配置</h3>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token punctuation">{</span>
	...
	<span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>对于包含命名视图的路由，你必须分别为每个命名视图添加 <code v-pre>props</code> 选项</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>    <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>之后我们就可以在该组件中利用<code v-pre>props</code>配置项接收参数，并且可以在任何地方使用该组件，使得该组件更易于重用和测试</p>
<h2 id="路由器的两种工作模式" tabindex="-1"><a class="header-anchor" href="#路由器的两种工作模式" aria-hidden="true">#</a> 路由器的两种工作模式</h2>
<ol>
<li>
<p>对于一个<code v-pre>url</code>来说，什么是<code v-pre>hash</code>值？—— #及其后面的内容就是 hash 值</p>
</li>
<li>
<p><code v-pre>hash</code>值不会包含在 <code v-pre>HTTP</code> 请求中，即：<code v-pre>hash</code>值不会带给服务器</p>
</li>
<li>
<p><code v-pre>hash</code>模式：</p>
<ol>
<li>地址中永远带着<code v-pre>#</code>号，不美观</li>
<li>若以后将地址通过第三方手机<code v-pre>app</code>分享，若<code v-pre>app</code>校验严格，则地址会被标记为不合法</li>
<li>兼容性较好</li>
</ol>
</li>
<li>
...
<ol>
<li>地址干净，美观</li>
<li>兼容性和<code v-pre>hash</code>模式相比略差</li>
<li>应用部署上线时需要后端人员支持，解决刷新页面服务端<code v-pre>404</code>的问题</li>
</ol>
</li>
</ol>
<div class="custom-container tip">
<p class="custom-container-title">提示</p>
<p><a href="https://www.npmjs.com/package/koa2-connect-history-api-fallback" target="_blank" rel="noopener noreferrer">koa2-connect-history-api-fallback <ExternalLinkIcon/></a></p>
<p><code v-pre>koa2</code>的一个中间件，用于处理<code v-pre>vue-router</code>使用 history 模式返回<code v-pre>index.html</code>，让<code v-pre>koa2</code>支持<code v-pre>SPA</code>应用程序</p>
</div>
<h2 id="导航守卫" tabindex="-1"><a class="header-anchor" href="#导航守卫" aria-hidden="true">#</a> 导航守卫 <Badge text='困难' type='error' /></h2>
<ol>
<li>
<p>作用：对路由进行权限控制</p>
</li>
...
<div class="custom-container tip">
<p class="custom-container-title">提示</p>
<pre><code>路由配置的 meta 对象里的信息是路由元信息,我们可以通过在 meta 里设置的状态,来判断是否需要进行登录验证.如果 meta 里的 isAuth 为 true,则需要判断是否已经登录,没登录就跳转到登录页.如果已登录则继续跳转.
</code></pre>
<p>前面说的 path,params,query 都可以存储信息,作为登录验证的状态标记.的确,它们也可以达到同样的效果.如果是少量单个的验证,使用它们问题不大.
但如果是多个路由都需要进行登录验证呢?path,params,query 是把信息显性地存储在 url 上的.并且多个路径都把一个相同的状态信息加在 url 上.这样就使 url 不再单纯,并且也很不优雅美观.
所以要优雅要隐性地传递信息,就使用 meta 对象吧</p>
</div>
<ol start="4">
<li>
<p>独享守卫:</p>
...
<li>
<p>具体编码：</p>
<div class="language-html ext-html line-numbers-mode"><pre v-pre class="language-html"><code>// include 缓存那个组件，这里写的是组件名 如果有多个,要写成数组形式
<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>keep-alive</span> <span class="token attr-name">include</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>News<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>
    <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>router-view</span><span class="token punctuation">></span></span>&lt;/ router-view>
...
<ul>
<li>
<p>作用：keep-alive 缓存的路由组件所独有的两个钩子，用于捕获路由组件的激活状态</p>
</li>
<li>
<p>具体名字：</p>
</li>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 将</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="把组件按块划分" tabindex="-1"><a class="header-anchor" href="#把组件按块划分" aria-hidden="true">#</a> 把组件按块划分</h3>
<p>有时候我们想把某个路由下的所有组件都打包在同个异步块 (chunk) 中。只需要使用命名 chunk，一个特殊的注释语法来提供 chunk name (需要 Webpack &gt; 2.4)：</p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token function-variable function">UserDetails</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token punctuation">)</span> <span class="token operator">=></span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>webpack 会将任何一个异步模块与相同的块名称组合到相同的异步块中。</p>
<h2 id="vue-router-4-x" tabindex="-1"><a class="header-anchor" href="#vue-router-4-x" aria-hidden="true">#</a> vue-router 4.x <Badge text='4.x补充' /></h2>
<h3 id="创建" tabindex="-1"><a class="header-anchor" href="#创建" aria-hidden="true">#</a> 创建</h3>
<ol>
<li>创建<code v-pre>src/router/index.js</code></li>
</ol>
...
<span class="token keyword">const</span> router<span class="token operator">=</span><span class="token function">createRouter</span><span class="token punctuation">(</span>
    <span class="token punctuation">{</span>
        ...
        <span class="token comment">// 创建hash路由</span>
...
<li><code v-pre>main.js</code>应用<code v-pre>vue-router</code></li>
</ol>
...
<span class="token comment">//导入router</span>
...
<span class="token comment">// 应用router</span>
app<span class="token punctuation">.</span><span class="token function">use</span><span class="token punctuation">(</span>ElementPlus<span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">use</span><span class="token punctuation">(</span>router<span class="token punctuation">)</span><span class="token punctuation">.</span><span class="token function">mount</span><span class="token punctuation">(</span><span class="token string">'#app'</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="在-setup-中访问路由和当前路由" tabindex="-1"><a class="header-anchor" href="#在-setup-中访问路由和当前路由" aria-hidden="true">#</a> 在 <code v-pre>setup</code> 中访问路由和当前路由</h2>
<div class="language-vue ext-vue line-numbers-mode"><pre v-pre class="language-vue"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>template</span><span class="token punctuation">></span></span>
  欢迎访问vue3+vite admin
 <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>el-button</span> <span class="token attr-name">@click</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">"</span>goLogin()<span class="token punctuation">"</span></span><span class="token punctuation">></span></span>去登陆<span class="token tag"><span class="token tag"><span class="token punctuation">&lt;/</span>el-button</span><span class="token punctuation">></span></span>
...
<span class="token comment">// 去登陆页面</span>
<span class="token keyword">const</span> <span class="token function-variable function">goLogin</span><span class="token operator">=</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token operator">=></span><span class="token punctuation">{</span>
