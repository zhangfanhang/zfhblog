...
<ul>
<li>将 transform 属性的值设置为 rotate()，即可实现旋转变形</li>
</ul>
<div class="language-css ext-css line-numbers-mode"><pre v-pre class="language-css"><code><span class="token property">transform</span><span class="token punctuation">:</span> <span class="token function">rotate</span><span class="token punctuation">(</span>45deg<span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><ul>
<li>若角度为正，则顺时针方向旋转，否则逆时针方向旋转</li>
</ul>
<h3 id="transform-origin-属性" tabindex="-1"><a class="header-anchor" href="#transform-origin-属性" aria-hidden="true">#</a> transform-origin 属性</h3>
<p>可以使用 transform-origin 属性设置自己的自定义变换原点，默认是以中心点作为变换原点</p>
<p><a href="https://developer.mozilla.org/zh-CN/docs/Web/CSS/transform-origin/" target="_blank" rel="noopener noreferrer">transform-origin(MDN)<ExternalLinkIcon/></a></p>
<h3 id="缩放变形" tabindex="-1"><a class="header-anchor" href="#缩放变形" aria-hidden="true">#</a> 缩放变形</h3>
<ul>
<li>将 transform 属性的值设置为 scale()，即可实现缩放变形</li>
<li>当数值小于 1 时，表示缩小元素；大于 1 表示放大元素</li>
</ul>
<h3 id="斜切变形" tabindex="-1"><a class="header-anchor" href="#斜切变形" aria-hidden="true">#</a> 斜切变形</h3>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h2 id="_3d-旋转" tabindex="-1"><a class="header-anchor" href="#_3d-旋转" aria-hidden="true">#</a> 3d 旋转</h2>
<p>将 transform 属性的值设置为 rotateX（）或者 rotateY（），即可实现绕横轴、纵轴旋转</p>
<p>注：<strong>rotateZ 和 rotate 效果一样</strong></p>
...
<ul>
<li>
<p>当元素进行 3D 旋转后，即可继续添加 translateX()、 translateY()、 translateZ()属性让元素在空间进行移动</p>
</li>
<li>
<p>以当前的旋转面形成坐标轴</p>
</li>
