<template><div><h2 id="cookie" tabindex="-1"><a class="header-anchor" href="#cookie" aria-hidden="true">#</a> Cookie</h2>
<h3 id="初识cookie" tabindex="-1"><a class="header-anchor" href="#初识cookie" aria-hidden="true">#</a> 初识cookie</h3>
<ul>
<li><strong>浏览器存储数据</strong>的一种方式</li>
<li>因为<strong>存储在用户本地</strong>，而不是存储在服务器上，是本地存储</li>
<li>一般会自动随着浏览器每次请求发送到服务器端</li>
</ul>
<p><strong>作用</strong>：利用<code v-pre>cookie</code>跟踪统计用户访问该网站的习惯，比如什么时间访问，访问了哪些页面，在每个网页的停留时间等</p>
<h3 id="cookie的基本方法" tabindex="-1"><a class="header-anchor" href="#cookie的基本方法" aria-hidden="true">#</a> cookie的基本方法</h3>
<ol>
<li>写入<code v-pre>cookie</code>: 不能一起设置，只能一个一个设置</li>
</ol>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>document<span class="token punctuation">.</span>cookie<span class="token operator">=</span><span class="token string">'username=zs'</span>
...
<li>读取<code v-pre>cookie</code>:读取的是一个由名值对构成的字符串，每个名值对之间由“;&quot;”（一个分号和一个空格）隔开</li>
</ol>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>document<span class="token punctuation">.</span>cookie  <span class="token comment">//username=zs; age=18</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="cookie的属性" tabindex="-1"><a class="header-anchor" href="#cookie的属性" aria-hidden="true">#</a> cookie的属性</h3>
<ol>
<li><code v-pre>cookie</code>的名称<code v-pre>Name</code>和值<code v-pre>Value</code></li>
</ol>
<ul>
<li>最重要的两个属性，创建<code v-pre>cookie</code>时必须填写，其他属性可以使用默认值</li>
<li><code v-pre>cookie</code>的名称或值如果包含非英文字母，则写入时需要使用 <code v-pre>encodeURIComponent()</code>编码，读取时使用<code v-pre>decodeURIComponent()</code>解码</li>
</ul>
...
<li>一般名称名称使用英文，不要用中文，值可以使用中文，但是要编码</li>
</ul>
<ol start="2">
<li>失效（到期）时间</li>
</ol>
<ul>
<li>
<p>对于失效的<code v-pre>cookie</code>，会被浏览器清除</p>
</li>
<li>
<p><strong>如果没有设置失效（到期）时间，这样的 Cookie称为<code v-pre>会话 Cookie</code> ，它存在内存中，当会话结束，也就是浏览器关闭时， Cookie消失</strong></p>
</li>
<li>
<p>想长时间存在，需要设置<code v-pre>expires</code>或 <code v-pre>max-age</code></p>
</li>
</ul>
<ol>
<li><code v-pre>expires</code><strong>值为Date类型</strong></li>
<li><code v-pre>max-age</code><strong>值为数字</strong>，表示当前时间+多少秒后过期，<strong>单位是秒</strong>；如果<code v-pre>max-age</code>的值为0或负数，则<code v-pre>cookie</code>会被删除</li>
</ol>
...
<p><code v-pre>Domain</code>限定了访问<code v-pre>cookie</code>的范围（不同域名），使用<code v-pre>JS</code><strong>只能读写</strong>当前域或父域的<code v-pre>cookie</code>，无法读写其他域的 <code v-pre>cookie</code></p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>document<span class="token punctuation">.</span>cookie<span class="token operator">=</span><span class="token string">'username=alex;domain=www.immoc.com'</span>
...
<p><code v-pre>path</code>限定了访问<code v-pre>cookie</code>的范围（同一域名），<strong>使用JS只能读写当前路径和上級路径的 Cookie，无法读写下级路径的 Cookie</strong></p>
<p><em><strong>当<code v-pre>Name</code>、 <code v-pre>Domain</code>、<code v-pre>Path</code>这3个字段都相同的时候，才是同一个 <code v-pre>cookie</code></strong></em></p>
<ul>
<li>HttpOnly</li>
</ul>
<p>设置了 <code v-pre>Httponly</code> 属性的Cookie不能通过JS访问</p>
<ul>
<li>Secure 安全标志</li>
</ul>
<p>限定了<strong>只有在使用了https而不是http的情况下</strong>才可以发送给服务端</p>
<p><em><strong><code v-pre>Domain</code>、<code v-pre>path</code>、 <code v-pre>Secure</code>都要满足条件，还不能过期的 Cookie才能随着请求发送到服务器端</strong></em></p>
<h3 id="cookie-的封装" tabindex="-1"><a class="header-anchor" href="#cookie-的封装" aria-hidden="true">#</a> Cookie 的封装</h3>
<div class="custom-container tip">
<p class="custom-container-title">`js-cookie`:一个用于处理`cookie`的简单、轻量级`JavaScript API`</p>
<p><a href="https://www.npmjs.com/package/js-cookie" target="_blank" rel="noopener noreferrer">JavaScript Cookie官方文档<ExternalLinkIcon/></a></p>
<p><a href="https://juejin.cn/post/6844904052510162952" target="_blank" rel="noopener noreferrer">js-cookie总结，vue构建的项目中使用js-cookie插件<ExternalLinkIcon/></a></p>
<p><a href="https://juejin.cn/post/6898630134530752520" target="_blank" rel="noopener noreferrer">前端鉴权的兄弟们：cookie、session、token、jwt、单点登录<ExternalLinkIcon/></a></p>
</div>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token comment">// 写入cookie</span>
<span class="token keyword">const</span> <span class="token function-variable function">set</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token parameter">name<span class="token punctuation">,</span> value<span class="token punctuation">,</span> <span class="token punctuation">{</span> maxAge<span class="token punctuation">,</span> domain<span class="token punctuation">,</span> path<span class="token punctuation">,</span> secure <span class="token punctuation">}</span> <span class="token operator">=</span> <span class="token punctuation">{</span><span class="token punctuation">}</span></span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
  ...
  <span class="token keyword">if</span> <span class="token punctuation">(</span>secure<span class="token punctuation">)</span> <span class="token punctuation">{</span>
    cookieText <span class="token operator">+=</span> <span class="token template-string"><span class="token template-punctuation string">`</span><span class="token string">; secure</span><span class="token template-punctuation string">`</span></span><span class="token punctuation">;</span>
  <span class="token punctuation">}</span>
...
<span class="token keyword">const</span> <span class="token function-variable function">get</span> <span class="token operator">=</span> <span class="token punctuation">(</span><span class="token parameter">name</span><span class="token punctuation">)</span> <span class="token operator">=></span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span><span class="token punctuation">;</span>
<span class="token keyword">export</span> <span class="token punctuation">{</span> set<span class="token punctuation">,</span> get<span class="token punctuation">,</span> remove <span class="token punctuation">}</span><span class="token punctuation">;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="cookie的注意事项" tabindex="-1"><a class="header-anchor" href="#cookie的注意事项" aria-hidden="true">#</a> cookie的注意事项</h3>
<ol>
<li>
<p><strong>前后端都可以创建<code v-pre>cookie</code></strong></p>
</li>
<li>
<p><code v-pre>cookie</code>有<strong>数量限制</strong>:当超过单个域名限制之后，在设置<code v-pre>cookie</code>,浏览器就会清除以前设置的<code v-pre>cookie</code></p>
</li>
</ol>
<p>3.<code v-pre> cookie</code> 有<strong>大小限制</strong>:每个<code v-pre>cookie</code>的存储容量很小，最多只有4kB左右</p>
<h2 id="localstorage" tabindex="-1"><a class="header-anchor" href="#localstorage" aria-hidden="true">#</a> localStorage</h2>
<h3 id="认识-localstorage" tabindex="-1"><a class="header-anchor" href="#认识-localstorage" aria-hidden="true">#</a> 认识 localStorage</h3>
<ul>
<li>
<p><code v-pre>localStorage</code>也是一种浏览器存储数据的方式（本地存储），它只是存储在本地，不会发送到服务器端</p>
</li>
<li>
<p>单个域名下的<code v-pre>localStorage</code>总大小有限制</p>
</li>
<li>
<p>基本用法：</p>
</li>
</ul>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code>localStorage<span class="token punctuation">.</span><span class="token function">setItem</span><span class="token punctuation">(</span><span class="token string">'username'</span><span class="token punctuation">,</span><span class="token string">'alex'</span><span class="token punctuation">)</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="localstorage的注意事项" tabindex="-1"><a class="header-anchor" href="#localstorage的注意事项" aria-hidden="true">#</a> localStorage的注意事项</h3>
<ol>
<li>存储期限<br>
持久化的本地存储，除非手动清除，比如通过js删除，或者清除浏览器缓存，否则数据是永远不会过期的。</li>
</ol>
<div class="custom-container tip">
<p class="custom-container-title">sessionStorage</p>
<p>当会话结束的时候，<code v-pre>sessionStorage</code>的数据会被清空,用法和<code v-pre>localStorage</code>一样</p>
</div>
<ol start="2">
<li><code v-pre>localStorage</code>键和值的类型</li>
</ol>
<p><em><strong>存储的键和值只能是字符串类型</strong></em>,不是字符串类型，也会先转化为字符串类型再存进去</p>
<ol start="3">
<li>
<p>不同域名下不能共用<code v-pre>localStorage</code></p>
</li>
<li>
<p>兼容性:<code v-pre>ie7</code>以下不支持</p>
</li>
</ol>
<div class="custom-container tip">
<p class="custom-container-title">查看网络技术的浏览器支持</p>
<p><a href="https://caniuse.com/" target="_blank" rel="noopener noreferrer">Can I use____?<ExternalLinkIcon/></a></p>
</div>
<h2 id="cookie-localstorage-sessionstorage三者对比" tabindex="-1"><a class="header-anchor" href="#cookie-localstorage-sessionstorage三者对比" aria-hidden="true">#</a> cookie,localStorage,SessionStorage三者对比</h2>
<p>见 前端面试-&gt; 计网&amp;浏览器面试题</p>
</div></template>
