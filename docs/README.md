...
bgImage: 'https://zfh-nanjing-bucket.oss-cn-nanjing.aliyuncs.com/blog-images/bg.webp'
actions:
  - text: 小记
    link: /小记/初来南京.html
    type: primary
...
projects:
  ...
  - name: v-list
    icon: vue
    desc: 一个基于vue的虚拟列表组件
    link: https://www.npmjs.com/package/@zhangfanhang/v-list
  ...
  - name: 去哪里
    icon: react
    desc: 一个基于react+ts+vite的仿去哪儿首页
    link: https://snake.zfhblog.top
  - name: koa2-message-board
    icon: node
    desc: 后端启蒙项目，基于elementUI+koa2+mongoDB的留言板
