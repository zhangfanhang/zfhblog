...
![if-else-if](https://zfh-oss.oss-cn-shanghai.aliyuncs.com/blog-images/if-else-if.png)

#### if 语句的嵌套

![游乐园门票](https://zfh-oss.oss-cn-shanghai.aliyuncs.com/blog-images/%E6%B8%B8%E4%B9%90%E5%9B%AD%E9%97%A8%E7%A5%A8.png)
...
![swtich语句-if](https://zfh-oss.oss-cn-shanghai.aliyuncs.com/blog-images/swtich%E8%AF%AD%E5%8F%A5-if.png)

![使用switch语句](https://zfh-oss.oss-cn-shanghai.aliyuncs.com/blog-images/%E4%BD%BF%E7%94%A8switch%E8%AF%AD%E5%8F%A5.png)
...
![直到遇到break](https://zfh-oss.oss-cn-shanghai.aliyuncs.com/blog-images/%E7%9B%B4%E5%88%B0%E9%81%87%E5%88%B0break.png)
...
![for语句的执行机理](https://zfh-oss.oss-cn-shanghai.aliyuncs.com/blog-images/for%E8%AF%AD%E5%8F%A5%E7%9A%84%E6%89%A7%E8%A1%8C%E6%9C%BA%E7%90%86.png)
...
- break 表示立即终止循环，它只能用在循环语句中，在 for 循环和 while 循环中都可以使用
  ![break-1](https://zfh-oss.oss-cn-shanghai.aliyuncs.com/blog-images/break-1.png)
- break 用在 while 语句中，通常和 While（true）{}搭配使用
  ![break-2](https://zfh-oss.oss-cn-shanghai.aliyuncs.com/blog-images/break-2.png)
  > while(true){}是一个死循环，通过 break 可以让它终止循环。
- continue 用于跳过循环中的一个迭代，并继续执行循环中的下一个迭代。
  ![continue](https://zfh-oss.oss-cn-shanghai.aliyuncs.com/blog-images/continue.png)

### do...while

- do while 循环是一种“后测试循环语句”。它不同于 for 循环和 While 循环每次都是“先测试条件是否满足，然后执行循环体″，do- While 循环是“先执行循环体，然后测试条件是否满足

![dowhile](https://zfh-oss.oss-cn-shanghai.aliyuncs.com/blog-images/dowhile.png)
...
![3循环对比](https://zfh-oss.oss-cn-shanghai.aliyuncs.com/blog-images/3%E5%BE%AA%E7%8E%AF%E5%AF%B9%E6%AF%94.png)
...
![莱布尼茨](https://zfh-oss.oss-cn-shanghai.aliyuncs.com/blog-images/%E8%8E%B1%E5%B8%83%E5%B0%BC%E8%8C%A8.png)
...
![循环的嵌套](https://zfh-oss.oss-cn-shanghai.aliyuncs.com/blog-images/%E5%BE%AA%E7%8E%AF%E7%9A%84%E5%B5%8C%E5%A5%97.png)
