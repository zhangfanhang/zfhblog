...
tags:
  - 浏览器
  - 作者：JowayYoung 源文章发布在掘金网
  - 网站流量几乎为零 仅供本人阅读学习查看 侵权联系删除
---
...
<span style='color:red'>批注：vue-cli脚手架项目已内置autoprefixer;vite内置了postcss,但没有内置autoprefixer,究其原因vue-cli是脚手架工具而非打包工具，它是更上层的应用，vite是打包工具</span>
